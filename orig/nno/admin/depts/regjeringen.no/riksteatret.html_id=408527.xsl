...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Underliggjande-etatar/riksteatret.html_id=408527'"/>
...
<xsl:variable name="para_nob" select="'riksteatret.html_id=408527'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'riikkateahter.html_id=408527'"/>
