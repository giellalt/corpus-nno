...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/Administrativ-leiing.html_id=280'"/>
...
<xsl:variable name="para_eng" select="'senior-administrative-staff.html_id=280'"/>
