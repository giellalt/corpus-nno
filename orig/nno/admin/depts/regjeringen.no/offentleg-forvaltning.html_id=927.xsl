...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Offentleg-forvaltning.html_id=927'"/>
...
<xsl:variable name="para_eng" select="'public-administration.html_id=927'"/>
