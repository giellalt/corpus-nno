...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/aktuelt/nyheiter/2010/Digitale-sprakverktoy-nodvendig-for-a-overleve.html_id=605543'"/>
...
<xsl:variable name="para_nob" select="'digitale-sprakverktoy-nodvendig-for-a-overleve.html_id=605543'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'digitala-giellareaiddut-leat-dehalaa-giela-ceavzimii.html_id=605543'"/>
