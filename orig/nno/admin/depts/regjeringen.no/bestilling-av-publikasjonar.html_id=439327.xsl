...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/bestilling-av-publikasjonar.html_id=439327'"/>
...
<xsl:variable name="para_nob" select="'bestilling-av-publikasjoner.html_id=439327'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'prentosiid-digon.html_id=439327'"/>
