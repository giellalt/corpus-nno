...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kd/Om-departementet/ansvarsomrade.html_id=611'"/>
...
<xsl:variable name="para_eng" select="'areas-of-responsibilities.html_id=611'"/>
