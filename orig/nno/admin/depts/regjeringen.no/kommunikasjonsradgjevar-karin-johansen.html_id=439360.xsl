...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/organisasjon/Avdelingar/Kommunikasjonseinga/Kommunikasjonsradgjevar-Karin-Johansen.html_id=439360'"/>
...
<xsl:variable name="para_eng" select="'communication-advisor.html_id=439360'"/>
