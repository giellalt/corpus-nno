...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/Hoyringar/Saker-pa-hoyring.html_id=1941'"/>
...
<xsl:variable name="para_nob" select="'paa_hoering.html_id=1941'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'se_saker-pa-horing.html_id=1941'"/>
