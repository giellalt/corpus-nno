...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Om-departementet/Organisasjon/Avdelingar.html_id=531'"/>
...
<xsl:variable name="para_eng" select="'departments.html_id=531'"/>
