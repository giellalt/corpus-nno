...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/pressesenter/pressemeldingar.html_id=482'"/>
...
<xsl:variable name="para_nob" select="'pressemeldinger.html_id=482'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'pressemeldinger.html_id=482'"/>
