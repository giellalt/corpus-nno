...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/hod/Nettstadskart.html_id=313850'"/>
...
<xsl:variable name="para_eng" select="'site-map.html_id=313850'"/>
