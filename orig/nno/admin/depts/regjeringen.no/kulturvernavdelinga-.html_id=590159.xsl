...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/kulturvernavdelinga-.html_id=590159'"/>
...
<xsl:variable name="para_eng" select="'cultural-heritage-department.html_id=590159'"/>
