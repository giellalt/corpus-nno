...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Underliggjande-etatar/rikskonsertane.html_id=408520'"/>
...
<xsl:variable name="para_nob" select="'rikskonsertene.html_id=408520'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'riikkakonsearttat.html_id=408520'"/>
