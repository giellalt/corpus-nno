...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn/anna-politisk-leiing.html_id=187'"/>
...
<xsl:variable name="para_eng" select="'other-political-staff.html_id=187'"/>
