...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/dokument/proposisjonar-og-meldingar/stortingsmeldingar.html_id=198'"/>
...
<xsl:variable name="para_nob" select="'stmeld.html_id=198'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stuorradiggedieahusat.html_id=198'"/>
