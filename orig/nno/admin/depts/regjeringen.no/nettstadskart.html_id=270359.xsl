...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Nettstadskart.html_id=270359'"/>
...
<xsl:variable name="para_eng" select="'site-map.html_id=270359'"/>
