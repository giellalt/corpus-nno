...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/dokument/Tiltredingserklaringa-for-regjeringa.html_id=256201'"/>
...
<xsl:variable name="para_eng" select="'inaugural-address.html_id=256201'"/>
