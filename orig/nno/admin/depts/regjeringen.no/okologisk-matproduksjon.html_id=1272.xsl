...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/okologisk-matproduksjon.html_id=1272'"/>
...
<xsl:variable name="para_nob" select="'okologisk.html_id=1272'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekologala-borramubuvttadeapmi.html_id=1272'"/>
