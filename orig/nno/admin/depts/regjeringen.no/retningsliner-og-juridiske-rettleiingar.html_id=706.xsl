...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/md/dokument/lover-og-reglar/Retningsliner-og-juridiske-rettleiingar.html_id=706'"/>
...
<xsl:variable name="para_nob" select="'retningslinjer.html_id=706'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'njuolggadusat-ja-juridihkala-bagadusat.html_id=706'"/>
