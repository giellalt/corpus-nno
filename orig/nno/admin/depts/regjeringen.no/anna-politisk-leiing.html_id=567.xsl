...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Anna-politisk-leiing.html_id=567'"/>
...
<xsl:variable name="para_eng" select="'other-political-staff.html_id=567'"/>
