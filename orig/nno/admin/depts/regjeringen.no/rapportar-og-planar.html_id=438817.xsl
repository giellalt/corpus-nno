...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/rapportar-og-planar.html_id=438817'"/>
...
<xsl:variable name="para_eng" select="'reports-and-plans.html_id=438817'"/>
