...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/NOU-ar.html_id=1767'"/>
...
<xsl:variable name="para_eng" select="'norwegian-official-reports.html_id=1767'"/>
