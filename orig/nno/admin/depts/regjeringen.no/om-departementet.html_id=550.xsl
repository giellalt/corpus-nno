...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet.html_id=550'"/>
...
<xsl:variable name="para_eng" select="'about-the-ministry.html_id=550'"/>
