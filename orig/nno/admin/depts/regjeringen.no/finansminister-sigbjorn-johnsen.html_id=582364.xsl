...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/finansminister-sigbjorn-johnsen.html_id=582364'"/>
...
<xsl:variable name="para_eng" select="'minister-of-finance-sigbjorn-johnsen.html_id=582364'"/>
