...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/nhd/Om-departementet.html_id=714'"/>
...
<xsl:variable name="para_eng" select="'about-the-ministry.html_id=714'"/>
