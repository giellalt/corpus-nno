...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/statsminister.html_id=445755'"/>
...
<xsl:variable name="para_eng" select="'primeminister.html_id=445755'"/>
