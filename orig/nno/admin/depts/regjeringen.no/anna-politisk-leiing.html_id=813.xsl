...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/anna-politisk-leiing.html_id=813'"/>
...
<xsl:variable name="para_eng" select="'other-political-staff.html_id=813'"/>
