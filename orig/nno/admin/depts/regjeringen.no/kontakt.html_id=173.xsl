...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn/kontakt.html_id=173'"/>
...
<xsl:variable name="para_eng" select="'contact.html_id=173'"/>
