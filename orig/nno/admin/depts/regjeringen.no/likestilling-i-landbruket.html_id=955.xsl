...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/likestilling-i-landbruket.html_id=955'"/>
...
<xsl:variable name="para_nob" select="'likestilling_i_landbruket.html_id=955'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dassearvu-eanadoalus.html_id=955'"/>
