...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Nettstadskart.html_id=313733'"/>
...
<xsl:variable name="para_eng" select="'site-map.html_id=313733'"/>
