...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/rapporter_planer/rapporter/2010/fylkesmannen-2010.html_id=621416'"/>
...
<xsl:variable name="para_nob" select="'fylkesmannen-2010.html_id=621416'"/>
