...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/aktuelt/Offentleg-elektronisk-postjournal.html_id=604997'"/>
...
<xsl:variable name="para_nob" select="'offentlig-elektronisk-postjournal.html_id=604997'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'byogkeles-elektronihken-paastejournale.html_id=604997'"/>
