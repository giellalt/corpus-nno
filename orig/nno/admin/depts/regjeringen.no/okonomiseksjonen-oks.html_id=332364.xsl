...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/Plan--okonomi--og-administrasjonsavdelin/Okonomiseksjonen-OKS.html_id=332364'"/>
...
<xsl:variable name="para_nob" select="'okonomiseksjonen-oks.html_id=332364'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekonomiijasekuvdna.html_id=332364'"/>
