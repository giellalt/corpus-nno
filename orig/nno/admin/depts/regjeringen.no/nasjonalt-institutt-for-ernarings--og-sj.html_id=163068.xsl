...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/Underliggjande-etatat/Nasjonalt-institutt-for-ernarings--og-sj.html_id=163068'"/>
...
<xsl:variable name="para_eng" select="'the-national-institute-of-nutrition-and-.html_id=163068'"/>
