...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Tema/Lovarbeid/Finnmarkslova.html_id=1269'"/>
...
<xsl:variable name="para_nob" select="'finnmarksloven.html_id=1269'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'finnmarkkulahka.html_id=1269'"/>
