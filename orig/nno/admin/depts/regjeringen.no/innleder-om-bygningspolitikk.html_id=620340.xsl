...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/dep/kommunal--og-regionalminister-liv-signe-/kalender/innleder-om-bygningspolitikk.html_id=620340'"/>
...
<xsl:variable name="para_nob" select="'innleder-om-bygningspolitikk.html_id=620340'"/>
