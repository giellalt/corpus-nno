...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/pressesenter/Pressekontaktar.html_id=87090'"/>
...
<xsl:variable name="para_eng" select="'press-contacts.html_id=87090'"/>
