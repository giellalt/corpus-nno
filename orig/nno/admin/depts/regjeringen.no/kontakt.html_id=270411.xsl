...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/kontakt.html_id=270411'"/>
...
<xsl:variable name="para_eng" select="'contact.html_id=270411'"/>
