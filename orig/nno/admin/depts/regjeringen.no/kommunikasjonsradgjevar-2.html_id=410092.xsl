...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/organisasjon/Avdelingar/Kommunikasjonseinga/Kommunikasjonsradgjevar-2.html_id=410092'"/>
...
<xsl:variable name="para_eng" select="'information-advisor-2.html_id=410092'"/>
