...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/dokument/proposisjonar-og-meldingar.html_id=369'"/>
...
<xsl:variable name="para_eng" select="'government-propositions-and-reports-.html_id=369'"/>
