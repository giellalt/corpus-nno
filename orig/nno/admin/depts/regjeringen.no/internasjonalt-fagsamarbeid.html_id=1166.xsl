...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Internasjonalt/Internasjonalt-fagsamarbeid.html_id=1166'"/>
...
<xsl:variable name="para_eng" select="'international-cooperation.html_id=1166'"/>
