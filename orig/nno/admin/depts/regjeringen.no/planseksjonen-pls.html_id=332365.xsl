...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/Plan--okonomi--og-administrasjonsavdelin/Planseksjonen-PLS.html_id=332365'"/>
...
<xsl:variable name="para_nob" select="'planseksjonen-pls.html_id=332365'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'planasekuvdna.html_id=332365'"/>
