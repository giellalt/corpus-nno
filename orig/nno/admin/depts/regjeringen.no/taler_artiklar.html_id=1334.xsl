...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/aktuelt/taler_artiklar.html_id=1334'"/>
...
<xsl:variable name="para_eng" select="'speeches_articles.html_id=1334'"/>
