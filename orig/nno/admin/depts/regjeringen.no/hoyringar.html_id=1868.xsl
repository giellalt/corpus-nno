...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/dokument/Hoyringar.html_id=1868'"/>
...
<xsl:variable name="para_nob" select="'horinger.html_id=1868'"/>
