...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/Veg--og-baneavdelinga-VB/Vegseksjonen-VS.html_id=332361'"/>
...
<xsl:variable name="para_nob" select="'vegseksjonen-vs.html_id=332361'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'luoddasekuvdna.html_id=332361'"/>
