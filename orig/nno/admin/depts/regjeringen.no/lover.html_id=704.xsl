...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/md/dokument/lover-og-reglar/lover.html_id=704'"/>
...
<xsl:variable name="para_eng" select="'acts.html_id=704'"/>
