...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/kampanjer/valportalen/stortingsval/legitimasjon.html_id=541951'"/>
...
<xsl:variable name="para_eng" select="'proof-of-identity-id.html_id=541951'"/>
