...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/organisasjon.html_id=281'"/>
...
<xsl:variable name="para_eng" select="'organisation.html_id=281'"/>
