...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/ud/Pressesenter/Pressemeldingar.html_id=852'"/>
...
<xsl:variable name="para_eng" select="'news.html_id=852'"/>
