...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/Rundskriv.html_id=1939'"/>
...
<xsl:variable name="para_nob" select="'rundskriv.html_id=1939'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'johtoallosat.html_id=1939'"/>
