...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/kampanjer/valportalen/stortingsval.html_id=538253'"/>
...
<xsl:variable name="para_eng" select="'the-parliamentary-storting-election.html_id=538253'"/>
