...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/-Om-departementet/Tilknytta-verksemder.html_id=115191'"/>
...
<xsl:variable name="para_eng" select="'offices-and-agencies-associated-with-the-ministry-of-children-and-equality.html_id=115191'"/>
