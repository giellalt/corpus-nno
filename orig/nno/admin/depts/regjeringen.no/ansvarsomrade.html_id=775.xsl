...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/oed/Om-departementet/Ansvarsomrade.html_id=775'"/>
...
<xsl:variable name="para_nob" select="'ansvarsomraader.html_id=775'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ovddasvastadussuorggit.html_id=775'"/>
