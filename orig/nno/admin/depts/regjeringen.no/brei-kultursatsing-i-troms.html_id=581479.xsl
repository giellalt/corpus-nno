...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/pressesenter/pressemeldingar/kirsten-almas-utnemnd-til-prost-i-byasen/brei-kultursatsing-i-troms.html_id=581479'"/>
...
<xsl:variable name="para_sme" select="'viiddis-kulturagiruan-tromssas-.html_id=581479'"/>
