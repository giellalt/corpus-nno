...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/Tilknytta-verksemder/Noregs-Bank.html_id=213276'"/>
...
<xsl:variable name="para_eng" select="'central-bank-of-norway.html_id=213276'"/>
