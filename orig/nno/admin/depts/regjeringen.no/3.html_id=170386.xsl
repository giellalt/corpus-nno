...
<xsl:variable name="filename" select="'http://www.regjeringen.no/nn/dep/kud/Dokument/proposisjonar-og-meldingar/Odelstingsproposisjonar/20012002/otprp-nr-114-2001-2002-/3.html_id=170386'"/>
...
<xsl:variable name="para_sme" select="'3.html_id=170404'"/>
