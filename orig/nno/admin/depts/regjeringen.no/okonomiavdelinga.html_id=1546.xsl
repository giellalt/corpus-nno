...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/Organisasjon/Avdelingar/okonomiavdelinga.html_id=1546'"/>
...
<xsl:variable name="para_eng" select="'the-economic-policy-department.html_id=1546'"/>
