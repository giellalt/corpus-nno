...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/Pressemeldingar/Mange-kommunar-med-auka-folketal-fyrste-kvartal-2010/505-millionar-meir-til-Nordland-neste-ar.html_id=619775'"/>
...
<xsl:variable name="para_sme" select="'505-miljovnna-ruvnno-eanet-nordlandii-bo.html_id=619775'"/>
