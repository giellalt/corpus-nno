...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/etatar-og-verksemder.html_id=115192'"/>
...
<xsl:variable name="para_eng" select="'underliggende-etater.html_id=115192'"/>
