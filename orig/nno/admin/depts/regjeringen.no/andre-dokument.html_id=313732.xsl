...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Dokument/Andre-dokument.html_id=313732'"/>
...
<xsl:variable name="para_nob" select="'andre.html_id=313732'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eara-dokumeanttat.html_id=313732'"/>
