...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/organisasjon/Avdelingar/ressurs--og-havavdelinga.html_id=1582'"/>
...
<xsl:variable name="para_eng" select="'department-of-marine-resources-and-envir.html_id=1582'"/>
