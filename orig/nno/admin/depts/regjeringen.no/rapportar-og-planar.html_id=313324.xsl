...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Dokument/Rapportar-og-planar.html_id=313324'"/>
...
<xsl:variable name="para_eng" select="'reports-and-plans.html_id=313324'"/>
