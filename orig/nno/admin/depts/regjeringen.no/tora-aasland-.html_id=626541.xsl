...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/bld/dep/tora-aasland-.html_id=626541'"/>
...
<xsl:variable name="para_nob" select="'tora-aasland-.html_id=626541'"/>
