...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/Om-regjeringa/Slik-arbeider-regjeringa.html_id=443781'"/>
...
<xsl:variable name="para_eng" select="'the-government-at-work.html_id=443781'"/>
