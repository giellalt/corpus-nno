...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/ud/Om-departementet/utenriksminister-jonas-gahr-store.html_id=1346'"/>
...
<xsl:variable name="para_eng" select="'minister_foreign.html_id=1346'"/>
