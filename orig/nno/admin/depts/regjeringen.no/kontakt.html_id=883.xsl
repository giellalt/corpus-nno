...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/statsministerens-kontor-2/Kontakt.html_id=883'"/>
...
<xsl:variable name="para_eng" select="'contact.html_id=883'"/>
