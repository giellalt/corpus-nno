...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/Aktuelt/Talar-og-artiklar.html_id=886'"/>
...
<xsl:variable name="para_eng" select="'speeches-and-articles.html_id=886'"/>
