...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet.html_id=221'"/>
...
<xsl:variable name="para_eng" select="'the-ministry.html_id=221'"/>
