...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/rapportar-og-planar/Rapportar.html_id=1769'"/>
...
<xsl:variable name="para_eng" select="'reports.html_id=1769'"/>
