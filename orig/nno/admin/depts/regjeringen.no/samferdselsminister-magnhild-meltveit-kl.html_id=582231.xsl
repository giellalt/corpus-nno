...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/samferdselsminister-magnhild-meltveit-kl.html_id=582231'"/>
...
<xsl:variable name="para_eng" select="'magnhild-meltveit-kleppa.html_id=582231'"/>
