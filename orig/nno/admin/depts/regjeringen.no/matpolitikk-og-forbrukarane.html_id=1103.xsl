...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/mat/matpolitikk-og-forbrukarane.html_id=1103'"/>
...
<xsl:variable name="para_nob" select="'forbruker_bolig_og_eiendom.html_id=1103'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'borramupolitihkka-ja-geavaheaddjit.html_id=1103'"/>
