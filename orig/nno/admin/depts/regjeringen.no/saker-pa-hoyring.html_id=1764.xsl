...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/Hoyringar/Saker-pa-hoyring.html_id=1764'"/>
...
<xsl:variable name="para_nob" select="'paa_hoering.html_id=1764'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ait-gulaskuddamis.html_id=1764'"/>
