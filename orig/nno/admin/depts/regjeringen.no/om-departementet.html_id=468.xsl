...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet.html_id=468'"/>
...
<xsl:variable name="para_eng" select="'about-the-ministry-of-justice-and-the-po.html_id=468'"/>
