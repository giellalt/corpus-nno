...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/informasjonseininga.html_id=1487'"/>
...
<xsl:variable name="para_eng" select="'department-of-information.html_id=1487'"/>
