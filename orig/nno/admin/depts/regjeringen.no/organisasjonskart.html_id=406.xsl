...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/om-departementet/organisasjon/organisasjonskart.html_id=406'"/>
...
<xsl:variable name="para_eng" select="'organisation-chart.html_id=406'"/>
