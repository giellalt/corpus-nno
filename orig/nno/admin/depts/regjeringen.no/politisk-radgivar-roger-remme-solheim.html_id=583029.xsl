...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Anna-politisk-leiing/politisk-radgivar-roger-remme-solheim.html_id=583029'"/>
...
<xsl:variable name="para_eng" select="'political-adviser-roger-remme-solheim.html_id=583029'"/>
