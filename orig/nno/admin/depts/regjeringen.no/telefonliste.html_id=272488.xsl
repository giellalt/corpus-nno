...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/kontakt/Telefonliste.html_id=272488'"/>
...
<xsl:variable name="para_nob" select="'telefonliste.html_id=272488'"/>
