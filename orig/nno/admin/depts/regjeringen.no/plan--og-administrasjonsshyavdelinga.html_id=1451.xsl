...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/Organisasjon/Avdelingar/Plan--og-administrasjonsshyavdelinga.html_id=1451'"/>
...
<xsl:variable name="para_eng" select="'the-administrative-affairs-department.html_id=1451'"/>
