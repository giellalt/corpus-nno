...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/om-departementet/grete-faremo.html_id=582237'"/>
...
<xsl:variable name="para_eng" select="'grete-faremo.html_id=582237'"/>
