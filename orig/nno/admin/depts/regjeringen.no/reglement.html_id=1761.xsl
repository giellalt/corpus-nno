...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/Laws/Reglement.html_id=1761'"/>
...
<xsl:variable name="para_nob" select="'reglement.html_id=1761'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'njuolggadusat.html_id=1761'"/>
