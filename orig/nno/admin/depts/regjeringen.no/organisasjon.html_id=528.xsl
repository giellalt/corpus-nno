...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Om-departementet/Organisasjon.html_id=528'"/>
...
<xsl:variable name="para_eng" select="'organisation.html_id=528'"/>
