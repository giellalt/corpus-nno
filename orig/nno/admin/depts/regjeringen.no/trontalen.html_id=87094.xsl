...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/dokument/Trontalen.html_id=87094'"/>
...
<xsl:variable name="para_eng" select="'the-speech-from-the-throne.html_id=87094'"/>
