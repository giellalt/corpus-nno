...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/md/dokument/Rundskriv.html_id=2011'"/>
...
<xsl:variable name="para_eng" select="'circulars.html_id=2011'"/>
