...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/pressesenter/pressemeldingar.html_id=184'"/>
...
<xsl:variable name="para_eng" select="'press-releases.html_id=184'"/>
