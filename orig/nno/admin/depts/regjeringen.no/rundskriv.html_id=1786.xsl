...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/dokument/rundskriv.html_id=1786'"/>
...
<xsl:variable name="para_nob" select="'rundskriv.html_id=1786'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gulaskuddamat.html_id=1786'"/>
