...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn/ansvarsomrade.html_id=190'"/>
...
<xsl:variable name="para_nob" select="'ansvarsomraader.html_id=190'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ansvarsomrader.html_id=190'"/>
