...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/etatar-og-verksemder/skatteetaten.html_id=270405'"/>
...
<xsl:variable name="para_eng" select="'the-tax-administration---the-directorate.html_id=270405'"/>
