...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Underliggjande-etatar/nasjonalbiblioteket.html_id=408537'"/>
...
<xsl:variable name="para_nob" select="'nasjonalbiblioteket.html_id=408537'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'naunalagirjerajus.html_id=408537'"/>
