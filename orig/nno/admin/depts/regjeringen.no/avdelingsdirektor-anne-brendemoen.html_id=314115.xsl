...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/transportavdelinga-ta/Miljo--og-kollektivtransportseksjonen/Avdelingsdirektor-Anne-Brendemoen.html_id=314115'"/>
...
<xsl:variable name="para_nob" select="'avdelingsdirektor-anne-brendemoen.html_id=314115'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'avdelingsdirektor-anne-brendemoen.html_id=314115'"/>
