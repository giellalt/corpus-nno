...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/-Om-departementet/Anna-politisk-leiing.html_id=320'"/>
...
<xsl:variable name="para_eng" select="'other-political-staff.html_id=320'"/>
