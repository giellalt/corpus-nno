...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/Tilknytta-verksemder.html_id=115193'"/>
...
<xsl:variable name="para_eng" select="'related-institutions.html_id=115193'"/>
