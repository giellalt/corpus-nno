...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/proposisjonar-og-meldingar.html_id=534'"/>
...
<xsl:variable name="para_eng" select="'white.html_id=534'"/>
