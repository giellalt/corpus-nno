...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/-Om-departementet/organisasjon/Avdelingar/Barne--og-ungdomsavdelinga-.html_id=81'"/>
...
<xsl:variable name="para_eng" select="'department-of-children-and-youth-policy.html_id=81'"/>
