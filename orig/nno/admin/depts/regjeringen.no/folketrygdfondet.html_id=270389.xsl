...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/etatar-og-verksemder/folketrygdfondet.html_id=270389'"/>
...
<xsl:variable name="para_eng" select="'national-insurance-scheme-fund.html_id=270389'"/>
