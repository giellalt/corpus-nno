...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/om-departementet/organisasjon.html_id=404'"/>
...
<xsl:variable name="para_eng" select="'organisation.html_id=404'"/>
