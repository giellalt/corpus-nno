...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/pressesenter/Pressemeldingar.html_id=399'"/>
...
<xsl:variable name="para_eng" select="'press-releases.html_id=399'"/>
