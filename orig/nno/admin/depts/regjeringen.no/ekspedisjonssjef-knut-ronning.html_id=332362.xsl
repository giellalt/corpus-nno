...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/Veg--og-baneavdelinga-VB/ekspedisjonssjef-knut-ronning.html_id=332362'"/>
...
<xsl:variable name="para_eng" select="'director-general-knut-ronning.html_id=332362'"/>
