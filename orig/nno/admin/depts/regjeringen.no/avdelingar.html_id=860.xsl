...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/ud/Om-departementet/Organisasjon/Avdelingar.html_id=860'"/>
...
<xsl:variable name="para_eng" select="'departments.html_id=860'"/>
