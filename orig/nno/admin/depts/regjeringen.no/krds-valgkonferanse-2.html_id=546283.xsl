...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/kampanjer/valg/for-valgmedarbeidere/krds-valgkonferanse-2.html_id=546283'"/>
...
<xsl:variable name="para_nob" select="'krds-valgkonferanse-2.html_id=546283'"/>
