...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/administrativ-leiing.html_id=814'"/>
...
<xsl:variable name="para_eng" select="'senior-administrative-staff.html_id=814'"/>
