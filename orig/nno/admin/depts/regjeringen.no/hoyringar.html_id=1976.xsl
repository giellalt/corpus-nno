...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kd/Dokument/Hoyringar.html_id=1976'"/>
...
<xsl:variable name="para_nob" select="'hoeringer.html_id=1976'"/>
