...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/om-departementet.html_id=385'"/>
...
<xsl:variable name="para_eng" select="'the-ministry.html_id=385'"/>
