...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/pressesenter/pressemeldingar.html_id=564'"/>
...
<xsl:variable name="para_nob" select="'pressemeldinger.html_id=564'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'preassadieahus.html_id=564'"/>
