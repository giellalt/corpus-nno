...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/pressesenter/Pressemeldingar/2010/Seks-millionar-til-kyrkjeval.html_id=604470'"/>
...
<xsl:variable name="para_nob" select="'seks-millioner-til-kirkevalg.html_id=604470'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'guhtta-milliuvnna-girkovalggaide.html_id=604470'"/>
