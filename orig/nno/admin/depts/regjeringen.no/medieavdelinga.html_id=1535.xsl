...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/Medieavdelinga.html_id=1535'"/>
...
<xsl:variable name="para_eng" select="'department-of-media-policy-and-copyright-.html_id=1535'"/>
