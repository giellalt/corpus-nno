...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/aktuelt/nyheiter/2010/Fornyingsministeren-drofta-digitalt-forsteval-med-toppleiarar-i-staten.html_id=604363'"/>
...
<xsl:variable name="para_nob" select="'fornyingsministeren-droftet-digitalt-forstevalg-med-toppledere-i-staten.html_id=604363'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oasmahttinministtar-digatalai-digitala-vuosttavalljema-stahta-njunnoiiguin.html_id=604363'"/>
