...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn/organisasjon/avdelingar/Presse--og-kommunikasjonsseksjonen.html_id=85803'"/>
...
<xsl:variable name="para_eng" select="'the-press-and-communications-division.html_id=85803'"/>
