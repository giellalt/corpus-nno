...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/kampanjer/valg/for-valgmedarbeidere/mandatfordeling-ved-stortingsvalget.html_id=535234'"/>
...
<xsl:variable name="para_nob" select="'mandatfordeling-ved-stortingsvalget.html_id=535234'"/>
