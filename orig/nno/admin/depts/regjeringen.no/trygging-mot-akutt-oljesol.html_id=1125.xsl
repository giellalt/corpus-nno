...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Tema/trygging-mot-akutt-oljesol.html_id=1125'"/>
...
<xsl:variable name="para_nob" select="'oljevernberedskap.html_id=1125'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oljosuddjengearggusvuohta.html_id=1125'"/>
