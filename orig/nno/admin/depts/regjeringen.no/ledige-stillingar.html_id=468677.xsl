...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Aktuelt/Ledige-stillingar.html_id=468677'"/>
...
<xsl:variable name="para_eng" select="'available-positions-in-the-children-equa.html_id=468677'"/>
