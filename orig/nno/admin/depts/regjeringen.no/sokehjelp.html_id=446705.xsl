...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/Om-nettstaden/Hjelp/sokehjelp.html_id=446705'"/>
...
<xsl:variable name="para_eng" select="'help-with-search.html_id=446705'"/>
