...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/md/Om-departementet/organisasjon.html_id=692'"/>
...
<xsl:variable name="para_eng" select="'organisation.html_id=692'"/>
