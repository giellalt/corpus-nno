...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/tema/planlegging_plan-_og_bygningsloven/planveiledere/sporsmal-og-svar-til-ny-plan--og-bygning.html_id=576821'"/>
...
<xsl:variable name="para_nob" select="'sporsmal-og-svar-til-ny-plan--og-bygning.html_id=576821'"/>
