...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/etatar-og-verksemder/toll--og-avgiftsetatentollvesenet.html_id=270408'"/>
...
<xsl:variable name="para_eng" select="'the-customs-and-excise-authorities.html_id=270408'"/>
