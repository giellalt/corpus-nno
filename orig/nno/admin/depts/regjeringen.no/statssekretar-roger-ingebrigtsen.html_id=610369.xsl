...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/om-departementet/Anna-politisk-leiing/statssekretar-roger-ingebrigtsen.html_id=610369'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-roger-ingebrigtsen.html_id=610369'"/>
