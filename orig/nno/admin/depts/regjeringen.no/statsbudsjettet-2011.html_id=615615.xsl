...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dok/statsbudsjettet/statsbudsjettet-2011.html_id=615615'"/>
...
<xsl:variable name="para_nob" select="'statsbudsjettet-2011.html_id=615615'"/>
