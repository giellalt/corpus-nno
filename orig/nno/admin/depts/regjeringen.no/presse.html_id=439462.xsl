...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/presse.html_id=439462'"/>
...
<xsl:variable name="para_nob" select="'presse.html_id=439462'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'preassaguovdda.html_id=439462'"/>
