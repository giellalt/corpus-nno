...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Tema/Lovarbeid/nyttig-tomtefesteinformasjon.html_id=497459'"/>
...
<xsl:variable name="para_nob" select="'nyttig-tomtefesteinformasjon.html_id=497459'"/>
