...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/Dokument/Hoyringar.html_id=1958'"/>
...
<xsl:variable name="para_nob" select="'hoeringer.html_id=1958'"/>
