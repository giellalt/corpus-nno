...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/anna-politisk-leiing/politisk-radgijevar-sigrid-brattabo-hand.html_id=586858'"/>
...
<xsl:variable name="para_eng" select="'political-adviser-sigrid-brattabo-handeg.html_id=586858'"/>
