...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet.html_id=262'"/>
...
<xsl:variable name="para_eng" select="'the-ministry-of-fisheries-and-coastal-affairs.html_id=262'"/>
