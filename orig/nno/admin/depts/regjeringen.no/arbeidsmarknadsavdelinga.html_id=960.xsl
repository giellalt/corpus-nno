...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn/organisasjon/avdelingar/Arbeidsmarknadsavdelinga.html_id=960'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-labour-market-affairs.html_id=960'"/>
