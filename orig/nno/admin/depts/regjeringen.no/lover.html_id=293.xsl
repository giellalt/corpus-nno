...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Dokument/Lover-og-reglar/Lover.html_id=293'"/>
...
<xsl:variable name="para_eng" select="'acts-and-regulations.html_id=293'"/>
