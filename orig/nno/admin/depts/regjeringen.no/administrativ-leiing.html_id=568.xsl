...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Administrativ-leiing.html_id=568'"/>
...
<xsl:variable name="para_nob" select="'administrativ_ledelse.html_id=568'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'halddahusla-joihus-.html_id=568'"/>
