...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/pressesenter/pressemeldingar.html_id=810'"/>
...
<xsl:variable name="para_eng" select="'press-releases.html_id=810'"/>
