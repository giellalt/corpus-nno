...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/md/Om-departementet.html_id=673'"/>
...
<xsl:variable name="para_eng" select="'about-the-ministry.html_id=673'"/>
