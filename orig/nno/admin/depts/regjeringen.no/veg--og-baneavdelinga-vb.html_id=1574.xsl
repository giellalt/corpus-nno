...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/Veg--og-baneavdelinga-VB.html_id=1574'"/>
...
<xsl:variable name="para_eng" select="'department-of-public-roads-and-rail-tran.html_id=1574'"/>
