...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/aktuelt/Taler-og-artiklar.html_id=391'"/>
...
<xsl:variable name="para_eng" select="'speeches-and-articles.html_id=391'"/>
