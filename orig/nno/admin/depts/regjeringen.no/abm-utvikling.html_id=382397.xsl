...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Underliggjande-etatar/abm-utvikling.html_id=382397'"/>
...
<xsl:variable name="para_nob" select="'abm-utvikling.html_id=382397'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'agv-ovdanahttin.html_id=382397'"/>
