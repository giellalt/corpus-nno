...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/om-departementet/Anna-politisk-leiing.html_id=361'"/>
...
<xsl:variable name="para_eng" select="'other-political-staff.html_id=361'"/>
