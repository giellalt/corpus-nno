...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/pressesenter/bildearkiv.html_id=194'"/>
...
<xsl:variable name="para_eng" select="'picture-archive.html_id=194'"/>
