...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/dok/regpubl/prop/2010-2011/prop-1-s-20102011.html_id=617299'"/>
...
<xsl:variable name="para_nob" select="'prop-1-s-20102011.html_id=617299'"/>
