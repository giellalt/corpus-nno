...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/om-departementet/administrativ-leiing.html_id=403'"/>
...
<xsl:variable name="para_eng" select="'senior-administrative-staff.html_id=403'"/>
