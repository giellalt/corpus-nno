...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/-Om-departementet/organisasjon.html_id=322'"/>
...
<xsl:variable name="para_eng" select="'organisation.html_id=322'"/>
