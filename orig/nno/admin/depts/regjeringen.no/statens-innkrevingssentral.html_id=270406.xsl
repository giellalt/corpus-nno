...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/etatar-og-verksemder/statens-innkrevingssentral.html_id=270406'"/>
...
<xsl:variable name="para_eng" select="'the-state-agency-for-the-recovery-of-fin.html_id=270406'"/>
