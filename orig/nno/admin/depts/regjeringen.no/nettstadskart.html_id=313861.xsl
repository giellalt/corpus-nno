...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/md/Nettstadskart.html_id=313861'"/>
...
<xsl:variable name="para_eng" select="'guided-tour.html_id=313861'"/>
