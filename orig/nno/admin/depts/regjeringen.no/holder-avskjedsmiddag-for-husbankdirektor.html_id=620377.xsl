...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/dep/kommunal--og-regionalminister-liv-signe-/kalender/Holder-avskjedsmiddag-for-husbankdirektor.html_id=620377'"/>
...
<xsl:variable name="para_nob" select="'holder-avskjedsmiddag-for-husbankdirektor.html_id=620377'"/>
