...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/statsminister/statsminister-jens-stoltenberg.html_id=1597'"/>
...
<xsl:variable name="para_eng" select="'prime-minister-jens-stoltenberg.html_id=1597'"/>
