...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/Organisasjon/Avdelingar.html_id=490'"/>
...
<xsl:variable name="para_eng" select="'departments.html_id=490'"/>
