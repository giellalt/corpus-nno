...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/statsministerens-kontor-2/Kontakt/telefonliste.html_id=224917'"/>
...
<xsl:variable name="para_nob" select="'telefonliste-statsministerens-kontor.html_id=224917'"/>
