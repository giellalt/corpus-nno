...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/om-departementet/Administrativ-leiing.html_id=362'"/>
...
<xsl:variable name="para_nob" select="'administrativ_ledelse.html_id=362'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'halddahusla-joihangoddi.html_id=362'"/>
