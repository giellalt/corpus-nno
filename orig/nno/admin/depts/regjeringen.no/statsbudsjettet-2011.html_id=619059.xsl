...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kud/dok/statsbudsjettet/statsbudsjettet-2011.html_id=619059'"/>
...
<xsl:variable name="para_nob" select="'statsbudsjettet-2011.html_id=619059'"/>
