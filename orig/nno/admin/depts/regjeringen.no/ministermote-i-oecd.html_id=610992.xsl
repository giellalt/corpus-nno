...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/hod/dep/helse--og-omsorgsminister-anne-grete-str/Kalender-til-helse--og-omsorgsminister-Anne-Grete-Strom-Erichsen/Ministermote-i-OECD.html_id=610992'"/>
...
<xsl:variable name="para_nob" select="'ministermote-i-oecd.html_id=610992'"/>
