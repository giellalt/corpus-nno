...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/transportavdelinga-ta.html_id=1575'"/>
...
<xsl:variable name="para_eng" select="'transport-department.html_id=1575'"/>
