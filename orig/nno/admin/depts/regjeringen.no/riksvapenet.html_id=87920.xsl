...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ud/dok/veiledninger/2002/riksvapenet.html_id=87920'"/>
...
<xsl:variable name="para_nob" select="'riksvapenet.html_id=87920'"/>
