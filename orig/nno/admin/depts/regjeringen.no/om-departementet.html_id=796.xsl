...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet.html_id=796'"/>
...
<xsl:variable name="para_eng" select="'about-the-ministry.html_id=796'"/>
