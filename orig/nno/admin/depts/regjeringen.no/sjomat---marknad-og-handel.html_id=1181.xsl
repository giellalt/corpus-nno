...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Tema/Sjomat---marknad-og-handel.html_id=1181'"/>
...
<xsl:variable name="para_nob" select="'sjomat_marked_og_handel.html_id=1181'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'norgga-mearrabiepmu-markanolaheapmi.html_id=1181'"/>
