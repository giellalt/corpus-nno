...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Dokument/proposisjonar-og-meldingar.html_id=328'"/>
...
<xsl:variable name="para_eng" select="'propositions-and-reports.html_id=328'"/>
