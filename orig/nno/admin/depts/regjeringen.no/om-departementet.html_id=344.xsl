...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/om-departementet.html_id=344'"/>
...
<xsl:variable name="para_eng" select="'about-the-ministry.html_id=344'"/>
