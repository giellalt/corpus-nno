...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kd/Pressesenter/Pressemeldingar.html_id=605'"/>
...
<xsl:variable name="para_eng" select="'press-releases.html_id=605'"/>
