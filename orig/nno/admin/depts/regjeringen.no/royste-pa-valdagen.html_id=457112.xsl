...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/kampanjer/valportalen/stortingsval/royste-pa-valdagen.html_id=457112'"/>
...
<xsl:variable name="para_eng" select="'how-to-vote-on-election-day.html_id=457112'"/>
