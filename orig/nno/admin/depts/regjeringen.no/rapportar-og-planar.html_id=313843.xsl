...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/dokument/rapportar-og-planar.html_id=313843'"/>
...
<xsl:variable name="para_eng" select="'reports-and-plans.html_id=313843'"/>
