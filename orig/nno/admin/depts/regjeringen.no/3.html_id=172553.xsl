...
<xsl:variable name="filename" select="'http://www.regjeringen.no/nn/dep/aid/dokument/proposisjonar-og-meldingar/Odelstingsproposisjonar/20022003/otprp-nr-34-2002-2003-/3.html_id=172553'"/>
...
<xsl:variable name="para_sme" select="'3.html_id=172562'"/>
