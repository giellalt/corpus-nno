...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/landbruk-og-naringsutvikling.html_id=1288'"/>
...
<xsl:variable name="para_nob" select="'landbruk_og_naringsutvikling.html_id=1288'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eanadoallu-ja-ealahusovddideapmi.html_id=1288'"/>
