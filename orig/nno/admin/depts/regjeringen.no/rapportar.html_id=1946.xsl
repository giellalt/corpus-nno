...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/Rapportar-og-planar/rapportar.html_id=1946'"/>
...
<xsl:variable name="para_eng" select="'reports.html_id=1946'"/>
