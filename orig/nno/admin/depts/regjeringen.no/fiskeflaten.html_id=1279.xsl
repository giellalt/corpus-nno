...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Tema/Fiske-og-fangst/fiskeflaten.html_id=1279'"/>
...
<xsl:variable name="para_nob" select="'fiskeflaten.html_id=1279'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bivdofanashivvodat.html_id=1279'"/>
