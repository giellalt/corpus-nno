...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Departemeanta-birra/Organisasvdna/Ossodagat-/Nuoskkidanaiid-ossodat/ekspediuvdnahoavda-lene-lyngby.html_id=85649'"/>
...
<xsl:variable name="para_eng" select="'deputy-director-general-lene-lyngby.html_id=85649'"/>
