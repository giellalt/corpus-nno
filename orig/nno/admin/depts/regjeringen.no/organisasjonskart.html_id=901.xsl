...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/statsministerens-kontor-2/Organisasjon/Organisasjonskart.html_id=901'"/>
...
<xsl:variable name="para_eng" select="'organization-map.html_id=901'"/>
