...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Dokument/Lover-og-reglar.html_id=276069'"/>
...
<xsl:variable name="para_eng" select="'laws-and-rules.html_id=276069'"/>
