...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/Lover-og-reglar.html_id=272526'"/>
...
<xsl:variable name="para_eng" select="'lover.html_id=540'"/>
