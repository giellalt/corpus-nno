...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/pressesenter/pressemeldingar/2009/--gratulerer-lavangen-kommune.html_id=578597'"/>
...
<xsl:variable name="para_sme" select="'--lihkku-loabat-suohkanii.html_id=578597'"/>
