...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/pressesenter/Pressemeldingar/2010/No-kan-du-kike-forvaltninga-i-korta.html_id=605000'"/>
...
<xsl:variable name="para_eng" select="'every-citizen-now-able-to-look-public-authorities-in-the-cards.html_id=605000'"/>
