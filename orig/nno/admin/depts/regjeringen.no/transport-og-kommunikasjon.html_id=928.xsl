...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Transport-og-kommunikasjon.html_id=928'"/>
...
<xsl:variable name="para_eng" select="'transport-and-communications.html_id=928'"/>
