...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/kampanjer/valportalen/stortingsval/valkort.html_id=541954'"/>
...
<xsl:variable name="para_eng" select="'polling-cards.html_id=541954'"/>
