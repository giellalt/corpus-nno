...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/Pressemeldingar/2009-2/nytt-kunnskapsprogram-for-auka-bulyst.html_id=555684'"/>
...
<xsl:variable name="para_sme" select="'oa-mahttoprogramma-geasuhan-dihtii-oa-as.html_id=555684'"/>
