...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/om-departementet/organisasjon/Avdelingar/sekretariat-for-leiinga.html_id=85699'"/>
...
<xsl:variable name="para_eng" select="'the-executive-secretariat.html_id=85699'"/>
