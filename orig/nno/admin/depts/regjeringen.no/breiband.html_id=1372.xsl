...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/Tema/ikt-politikk/Breiband.html_id=1372'"/>
...
<xsl:variable name="para_nob" select="'bredband.html_id=1372'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'uggabaddi.html_id=1372'"/>
