...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/kampanjer/valg/for-valgmedarbeidere/nytt-og-nytting.html_id=544857'"/>
...
<xsl:variable name="para_nob" select="'nytt-og-nytting.html_id=544857'"/>
