...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/Organisasjon.html_id=487'"/>
...
<xsl:variable name="para_eng" select="'organization.html_id=487'"/>
