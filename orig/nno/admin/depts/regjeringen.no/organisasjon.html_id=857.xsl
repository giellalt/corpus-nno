...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/ud/Om-departementet/Organisasjon.html_id=857'"/>
...
<xsl:variable name="para_eng" select="'organisation.html_id=857'"/>
