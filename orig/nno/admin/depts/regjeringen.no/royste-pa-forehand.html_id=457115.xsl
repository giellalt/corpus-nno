...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/kampanjer/valportalen/stortingsval/royste-pa-forehand.html_id=457115'"/>
...
<xsl:variable name="para_eng" select="'how-to-vote-in-advance.html_id=457115'"/>
