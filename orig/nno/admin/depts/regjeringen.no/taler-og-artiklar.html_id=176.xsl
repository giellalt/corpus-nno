...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/aktuelt/taler-og-artiklar.html_id=176'"/>
...
<xsl:variable name="para_eng" select="'speeches-and-articles.html_id=176'"/>
