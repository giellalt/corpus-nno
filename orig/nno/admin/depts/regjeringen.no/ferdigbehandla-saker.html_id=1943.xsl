...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/Hoyringar/Ferdigbehandla-saker.html_id=1943'"/>
...
<xsl:variable name="para_nob" select="'ferdigbehandlet.html_id=1943'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'se_ferdigbehandlede-saker.html_id=1943'"/>
