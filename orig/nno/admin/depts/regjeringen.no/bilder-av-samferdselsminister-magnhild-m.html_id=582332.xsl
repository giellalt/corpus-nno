...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/samferdselsminister-magnhild-meltveit-kl/bilder-av-samferdselsminister-magnhild-m.html_id=582332'"/>
...
<xsl:variable name="para_eng" select="'photo-gallery---minister-of-transport-an.html_id=582332'"/>
