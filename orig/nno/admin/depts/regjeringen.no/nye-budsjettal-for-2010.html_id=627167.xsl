...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/pressesenter/Pressemeldingar/2010/nye-budsjettal-for-2010.html_id=627167'"/>
...
<xsl:variable name="para_nob" select="'nye-budsjettall-for-2010.html_id=627167'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'jagi-2010-bueahta-oa-logut.html_id=627167'"/>
