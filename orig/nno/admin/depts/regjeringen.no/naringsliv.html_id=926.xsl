...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Naringsliv.html_id=926'"/>
...
<xsl:variable name="para_eng" select="'business-and-industry.html_id=926'"/>
