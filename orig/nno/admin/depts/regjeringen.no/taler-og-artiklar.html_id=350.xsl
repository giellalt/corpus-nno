...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/aktuelt/taler-og-artiklar.html_id=350'"/>
...
<xsl:variable name="para_nob" select="'taler_og_artikler.html_id=350'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'taler_og_artikler.html_id=350'"/>
