...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Om-departementet/kommunal--og-regionalminister-liv-signe-.html_id=582254'"/>
...
<xsl:variable name="para_eng" select="'minister-of-local-government-and-regiona.html_id=582254'"/>
