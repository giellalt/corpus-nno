...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/tema/arbeidsmarkedspolitikk.html_id=935'"/>
...
<xsl:variable name="para_eng" select="'labour-market-policy.html_id=935'"/>
