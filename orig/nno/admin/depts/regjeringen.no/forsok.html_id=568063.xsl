...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/kampanjer/valportalen/forsok.html_id=568063'"/>
...
<xsl:variable name="para_nob" select="'forsok.html_id=568063'"/>
