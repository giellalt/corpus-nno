...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/samfunnssikkerheit/Fugleinfluensa.html_id=1123'"/>
...
<xsl:variable name="para_nob" select="'fugleinfluensa.html_id=1123'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'loddeinflueansa.html_id=1123'"/>
