...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/kampanjer/valportalen/stortingsval/valoppgjer-kven-blir-vald.html_id=570018'"/>
...
<xsl:variable name="para_eng" select="'determining-the-election-results-who-get.html_id=570018'"/>
