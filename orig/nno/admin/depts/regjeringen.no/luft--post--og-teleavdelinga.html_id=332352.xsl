...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/Luft--post--og-teleavdelinga.html_id=332352'"/>
...
<xsl:variable name="para_eng" select="'department-of-civil-aviation-postal-serv.html_id=332352'"/>
