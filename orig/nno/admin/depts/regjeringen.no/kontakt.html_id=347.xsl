...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/om-departementet/Kontakt.html_id=347'"/>
...
<xsl:variable name="para_eng" select="'contact.html_id=347'"/>
