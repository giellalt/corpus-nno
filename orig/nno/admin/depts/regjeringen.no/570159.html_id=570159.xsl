...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/kampanjer/valportalen/sametingsvalg/570159.html_id=570159'"/>
...
<xsl:variable name="para_nob" select="'stemmerett-og-manntall-ved-sametingsvalg.html_id=570159'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'jienastanvuoigatvuohta-ja-jienastuslohku.html_id=570159'"/>
