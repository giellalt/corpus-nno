...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/samfunns--og-frivillighetsavdelinga.html_id=495694'"/>
...
<xsl:variable name="para_eng" select="'department-of-civil-society-and-the-voluntary-sector.html_id=495694'"/>
