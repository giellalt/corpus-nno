...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/om-departementet/organisasjon/Avdelingar/avdeling-for-okonomi-og-styring.html_id=1353'"/>
...
<xsl:variable name="para_eng" select="'the-department-for-finance-and-managemen.html_id=1353'"/>
