...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/kampanjer/tolkningsuttalelser.html_id=441575'"/>
...
<xsl:variable name="para_nob" select="'tolkningsuttalelser.html_id=441575'"/>
