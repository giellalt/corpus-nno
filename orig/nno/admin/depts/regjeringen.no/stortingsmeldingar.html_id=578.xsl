...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/Dokument/proposisjonar-og-meldingar/stortingsmeldingar.html_id=578'"/>
...
<xsl:variable name="para_nob" select="'stmeld.html_id=578'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dieahusat-stuorradiggai.html_id=578'"/>
