...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/om-departementet/organisasjon/Avdelingar/avdeling-for-forsvarspolitikk-og-langtid.html_id=1352'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-defence-policy-and-lon.html_id=1352'"/>
