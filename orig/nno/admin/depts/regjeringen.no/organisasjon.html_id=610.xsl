...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kd/Om-departementet/Organisasjon.html_id=610'"/>
...
<xsl:variable name="para_eng" select="'organisation.html_id=610'"/>
