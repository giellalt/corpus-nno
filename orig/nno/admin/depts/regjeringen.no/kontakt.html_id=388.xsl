...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/om-departementet/kontakt.html_id=388'"/>
...
<xsl:variable name="para_eng" select="'ministry-of-defence.html_id=388'"/>
