...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/samfunns--og-frivillighetsavdelinga/ekspedisjonssjef-birgitte-lange.html_id=551551'"/>
...
<xsl:variable name="para_eng" select="'director-general-birgitte-lange.html_id=551551'"/>
