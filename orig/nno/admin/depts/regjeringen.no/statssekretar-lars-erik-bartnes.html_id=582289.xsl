...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/anna-politisk-leiing/statssekretar-lars-erik-bartnes.html_id=582289'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-lars-erik-bartnes.html_id=582289'"/>
