...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn/Tilknytta-verksemder.html_id=87142'"/>
...
<xsl:variable name="para_nob" select="'tilknyttede_virksomheter.html_id=87142'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'atnaseaddji-doaimmahusat.html_id=87142'"/>
