...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/-Om-departementet.html_id=303'"/>
...
<xsl:variable name="para_eng" select="'bld-arbeider-for-at.html_id=303'"/>
