...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/kampanjer/valg/valgobservasjon/lenker.html_id=573467'"/>
...
<xsl:variable name="para_eng" select="'links.html_id=573467'"/>
