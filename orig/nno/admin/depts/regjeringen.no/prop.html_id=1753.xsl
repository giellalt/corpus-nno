...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/proposisjonar-og-meldingar/prop.html_id=1753'"/>
...
<xsl:variable name="para_nob" select="'prop.html_id=1753'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'odeldiggeproposiuvnnat.html_id=1753'"/>
