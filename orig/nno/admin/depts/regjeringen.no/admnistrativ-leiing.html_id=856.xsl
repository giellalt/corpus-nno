...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/ud/Om-departementet/Admnistrativ-leiing.html_id=856'"/>
...
<xsl:variable name="para_eng" select="'senior-administrative-staff-2.html_id=856'"/>
