...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/Organisasjon/Avdelingar/Skatteokonomisk-avdeling.html_id=1547'"/>
...
<xsl:variable name="para_eng" select="'tax_policy_department.html_id=1547'"/>
