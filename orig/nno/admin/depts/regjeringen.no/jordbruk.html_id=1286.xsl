...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/jordbruk.html_id=1286'"/>
...
<xsl:variable name="para_nob" select="'jordbruk.html_id=1286'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eanadoallu.html_id=1286'"/>
