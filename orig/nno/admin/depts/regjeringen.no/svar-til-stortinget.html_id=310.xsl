...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Aktuelt/Svar-til-Stortinget.html_id=310'"/>
...
<xsl:variable name="para_eng" select="'replies-to-the-storting.html_id=310'"/>
