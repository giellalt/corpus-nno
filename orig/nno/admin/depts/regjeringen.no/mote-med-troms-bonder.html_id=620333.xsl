...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/dep/landbruks--og-matminister-lars-peder-bre/kalender/2010-3/Mote-med-Troms-bonder.html_id=620333'"/>
...
<xsl:variable name="para_nob" select="'mote-med-troms-bonder.html_id=620333'"/>
