...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/presse/Pressemeldingar.html_id=1781'"/>
...
<xsl:variable name="para_eng" select="'press-releases.html_id=1781'"/>
