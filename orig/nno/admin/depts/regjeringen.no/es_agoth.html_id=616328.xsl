...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/ud/Om-departementet/utviklingsminister-erik-solheim-sv/Kalenderen-til-Utviklingsministeren/es_agoth.html_id=616328'"/>
...
<xsl:variable name="para_nob" select="'es_agoth.html_id=616328'"/>
