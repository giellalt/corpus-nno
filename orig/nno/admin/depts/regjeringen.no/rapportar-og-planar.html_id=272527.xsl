...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/Rapportar-og-planar.html_id=272527'"/>
...
<xsl:variable name="para_eng" select="'rapporter.html_id=1946'"/>
