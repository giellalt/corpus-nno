...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/kontakt.html_id=471'"/>
...
<xsl:variable name="para_eng" select="'contact.html_id=471'"/>
