...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar.html_id=818'"/>
...
<xsl:variable name="para_eng" select="'departments.html_id=818'"/>
