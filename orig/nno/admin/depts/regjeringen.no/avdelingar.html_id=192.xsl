...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn/organisasjon/avdelingar.html_id=192'"/>
...
<xsl:variable name="para_eng" select="'departments.html_id=192'"/>
