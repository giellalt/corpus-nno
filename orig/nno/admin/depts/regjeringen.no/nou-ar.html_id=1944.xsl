...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/NOU-ar.html_id=1944'"/>
...
<xsl:variable name="para_nob" select="'nouer.html_id=1944'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'na-at.html_id=1944'"/>
