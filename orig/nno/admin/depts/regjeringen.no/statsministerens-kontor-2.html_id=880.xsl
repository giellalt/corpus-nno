...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/statsministerens-kontor-2.html_id=880'"/>
...
<xsl:variable name="para_eng" select="'the-office-of-the-prime-minister.html_id=880'"/>
