...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/samfunntryggleik-og-forsvar.html_id=215'"/>
...
<xsl:variable name="para_eng" select="'civil-protection-and-defence.html_id=215'"/>
