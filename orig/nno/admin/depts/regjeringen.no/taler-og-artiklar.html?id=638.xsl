...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/aktuelt/Taler-og-artiklar.html?id=638'"/>
...
<xsl:variable name="para_eng" select="'speeches-and-articles.html?id=638'"/>
