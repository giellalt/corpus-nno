...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/internasjonalt-samarbeid-om-landbruk-og-.html_id=1185'"/>
...
<xsl:variable name="para_nob" select="'nternasjonalt_samarbeid_om_mat_og_landbr.html_id=1185'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'riikkaidgaskasa-ovttasbargu-eanadoalus-j.html_id=1185'"/>
