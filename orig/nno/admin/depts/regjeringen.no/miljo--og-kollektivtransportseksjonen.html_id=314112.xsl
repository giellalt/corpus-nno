...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/transportavdelinga-ta/Miljo--og-kollektivtransportseksjonen.html_id=314112'"/>
...
<xsl:variable name="para_nob" select="'miljo--og-kollektivtransportseksjonen.html_id=314112'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'luodda--ja-mearrajohtolatsekuvdna.html_id=314112'"/>
