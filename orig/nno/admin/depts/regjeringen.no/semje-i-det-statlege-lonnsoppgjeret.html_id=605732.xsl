...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/pressesenter/Pressemeldingar/2010/Semje-i-det-statlege-lonnsoppgjeret.html_id=605732'"/>
...
<xsl:variable name="para_nob" select="'enighet-i-det-statlige-lonnsoppgjoret.html_id=605732'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ovttamielalavuohta-balkaiehtadallamis.html_id=605732'"/>
