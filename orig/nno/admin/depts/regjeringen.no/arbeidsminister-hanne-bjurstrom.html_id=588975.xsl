...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn/arbeidsminister-hanne-bjurstrom.html_id=588975'"/>
...
<xsl:variable name="para_eng" select="'minister-of-labour-hanne-bjurstrom.html_id=588975'"/>
