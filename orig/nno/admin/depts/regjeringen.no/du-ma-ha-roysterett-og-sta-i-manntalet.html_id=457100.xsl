...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/kampanjer/valportalen/stortingsval/du-ma-ha-roysterett-og-sta-i-manntalet.html_id=457100'"/>
...
<xsl:variable name="para_eng" select="'right-to-vote-and-electoral-register.html_id=457100'"/>
