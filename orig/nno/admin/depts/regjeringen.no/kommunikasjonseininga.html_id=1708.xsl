...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Om-departementet/Organisasjon/Avdelingar/Kommunikasjonseininga.html_id=1708'"/>
...
<xsl:variable name="para_eng" select="'the-communication-unit.html_id=1708'"/>
