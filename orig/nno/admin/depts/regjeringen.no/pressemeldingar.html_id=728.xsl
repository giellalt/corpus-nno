...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/nhd/Pressesenter/Pressemeldingar.html_id=728'"/>
...
<xsl:variable name="para_eng" select="'press-releases.html_id=728'"/>
