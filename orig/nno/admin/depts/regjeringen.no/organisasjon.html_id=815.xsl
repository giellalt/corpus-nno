...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon.html_id=815'"/>
...
<xsl:variable name="para_eng" select="'organisation.html_id=815'"/>
