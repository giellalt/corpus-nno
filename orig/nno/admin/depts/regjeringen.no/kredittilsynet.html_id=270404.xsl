...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/etatar-og-verksemder/kredittilsynet.html_id=270404'"/>
...
<xsl:variable name="para_eng" select="'the-financial-supervisory-authority.html_id=270404'"/>
