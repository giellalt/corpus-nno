...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/md/dokument.html_id=270420'"/>
...
<xsl:variable name="para_eng" select="'documents-and-publications.html_id=270420'"/>
