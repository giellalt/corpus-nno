...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/dok/bud/krd-statsbudsjett-2011.html_id=614746'"/>
...
<xsl:variable name="para_nob" select="'krd-statsbudsjett-2011.html_id=614746'"/>
