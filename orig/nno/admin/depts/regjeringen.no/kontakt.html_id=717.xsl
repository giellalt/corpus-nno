...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/nhd/Om-departementet/Kontakt.html_id=717'"/>
...
<xsl:variable name="para_eng" select="'contact.html_id=717'"/>
