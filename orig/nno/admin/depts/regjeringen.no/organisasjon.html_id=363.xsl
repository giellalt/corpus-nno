...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/om-departementet/organisasjon.html_id=363'"/>
...
<xsl:variable name="para_eng" select="'organisation.html_id=363'"/>
