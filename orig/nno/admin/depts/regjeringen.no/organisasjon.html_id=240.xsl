...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/Organisasjon.html_id=240'"/>
...
<xsl:variable name="para_eng" select="'about-the-ministry.html_id=240'"/>
