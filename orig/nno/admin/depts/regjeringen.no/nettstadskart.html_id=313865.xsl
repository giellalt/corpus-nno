...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/nhd/Nettstadskart.html_id=313865'"/>
...
<xsl:variable name="para_eng" select="'site-map.html_id=313865'"/>
