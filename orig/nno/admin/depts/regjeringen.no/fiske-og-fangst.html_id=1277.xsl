...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Tema/Fiske-og-fangst.html_id=1277'"/>
...
<xsl:variable name="para_nob" select="'fiske_og_fangst.html_id=1277'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'guollebivdu-ja-bivdu.html_id=1277'"/>
