...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/skogbruk_og_bioenergi.html_id=1292'"/>
...
<xsl:variable name="para_nob" select="'skogbruk_og_bioenergi.html_id=1292'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'vuovdedoallu-ja-bioenergiija.html_id=1292'"/>
