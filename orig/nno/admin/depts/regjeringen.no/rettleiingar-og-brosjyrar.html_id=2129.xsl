...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/Rettleiingar-og-brosjyrar.html_id=2129'"/>
...
<xsl:variable name="para_eng" select="'handbooks.html_id=2129'"/>
