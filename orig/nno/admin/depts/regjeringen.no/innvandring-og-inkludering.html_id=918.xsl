...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Innvandring-og-inkludering.html_id=918'"/>
...
<xsl:variable name="para_eng" select="'immigration-and-social-inclusion.html_id=918'"/>
