...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kd/Dokument/Lover-og-reglar.html_id=313564'"/>
...
<xsl:variable name="para_eng" select="'legislation.html_id=313564'"/>
