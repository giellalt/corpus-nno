...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/Tilknytta-verksemder/Mattilsynet.html_id=163326'"/>
...
<xsl:variable name="para_eng" select="'the-norwegian-food-safety-authority.html_id=163326'"/>
