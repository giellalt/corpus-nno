...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Dokument/Rettleiingar-og-brosjyrar.html_id=2083'"/>
...
<xsl:variable name="para_eng" select="'guidelines-and-brochures.html_id=2083'"/>
