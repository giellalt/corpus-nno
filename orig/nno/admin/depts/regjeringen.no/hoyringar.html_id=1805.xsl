...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Dokument/Hoyringar.html_id=1805'"/>
...
<xsl:variable name="para_nob" select="'hoyringar.html_id=1805'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gulaskuddamat.html_id=1805'"/>
