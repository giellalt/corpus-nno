...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Underliggjande-etatar.html_id=115207'"/>
...
<xsl:variable name="para_nob" select="'underliggende_etater.html_id=115207'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'vuollasa-asahusat.html_id=115207'"/>
