...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/Dokument/proposisjonar-og-meldingar.html_id=575'"/>
...
<xsl:variable name="para_nob" select="'regpubl.html_id=575'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'proposiuvnnat-ja-dieahusat.html_id=575'"/>
