...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Mat-fiskeri-og-landbruk.html_id=924'"/>
...
<xsl:variable name="para_eng" select="'food-fisheries-and-agriculture.html_id=924'"/>
