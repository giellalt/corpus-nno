...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/bustad-og-eigedom.html_id=211'"/>
...
<xsl:variable name="para_eng" select="'housing-and-property.html_id=211'"/>
