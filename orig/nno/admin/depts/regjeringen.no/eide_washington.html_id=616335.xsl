...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/ud/Om-departementet/Anna-politisk-leiing/cv_eide/ebei_kalender/eide_washington.html_id=616335'"/>
...
<xsl:variable name="para_sme" select="'eide_washington.html_id=616335'"/>
