...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/aktuelt/Taler-og-artiklar/ministaren.html_id=573146'"/>
...
<xsl:variable name="para_eng" select="'minister.html_id=573146'"/>
