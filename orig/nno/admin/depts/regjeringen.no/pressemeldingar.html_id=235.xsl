...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/pressesenter/Pressemeldingar.html_id=235'"/>
...
<xsl:variable name="para_eng" select="'press-releases.html_id=235'"/>
