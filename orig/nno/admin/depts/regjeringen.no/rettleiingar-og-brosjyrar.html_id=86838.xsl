...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/reindrift/Rettleiingar-og-brosjyrar.html_id=86838'"/>
...
<xsl:variable name="para_nob" select="'brosjyrer-og-veiledninger.html_id=86838'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'almmuhusat.html_id=86838'"/>
