...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/pressesenter/Pressemeldingar/2010/Kan-spare-milliardar-pa-smartare-groftegraving-for-breiband.html_id=607412'"/>
...
<xsl:variable name="para_nob" select="'kan-spare-milliarder-pa-smartere-groftegraving-for-bredband.html_id=607412'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'vejola-seastit-miljarddaid-jos-goaivu-eara-vugiid-mielde-goivvohagaid--govdafierpmadahkii.html_id=607412'"/>
