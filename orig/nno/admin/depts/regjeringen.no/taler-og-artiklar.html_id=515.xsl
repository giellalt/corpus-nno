...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Aktuelt/taler-og-artiklar.html_id=515'"/>
...
<xsl:variable name="para_eng" select="'speeches_articles.html_id=515'"/>
