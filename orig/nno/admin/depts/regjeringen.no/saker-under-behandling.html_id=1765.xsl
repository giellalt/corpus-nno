...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/Hoyringar/Saker-under-behandling.html_id=1765'"/>
...
<xsl:variable name="para_nob" select="'under_behandling.html_id=1765'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ait-mat-leat-meannuduvvomin-.html_id=1765'"/>
