...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/mat.html_id=1270'"/>
...
<xsl:variable name="para_nob" select="'mat.html_id=1270'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'borramu.html_id=1270'"/>
