...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/Anna-politisk-leiing-.html_id=238'"/>
...
<xsl:variable name="para_eng" select="'other-political-staff.html_id=238'"/>
