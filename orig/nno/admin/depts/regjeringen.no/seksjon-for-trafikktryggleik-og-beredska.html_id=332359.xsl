...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/Veg--og-baneavdelinga-VB/Seksjon-for-trafikktryggleik-og-beredska.html_id=332359'"/>
...
<xsl:variable name="para_nob" select="'trafikksikkerhets--og-beredskapsseksjone.html_id=332359'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'johtolatsihkkarvuoa--gearggusvuoasekuvdna.html_id=332359'"/>
