...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/Pressemeldingar.html_id=523'"/>
...
<xsl:variable name="para_eng" select="'press-releases.html_id=523'"/>
