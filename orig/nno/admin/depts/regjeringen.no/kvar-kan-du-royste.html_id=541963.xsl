...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/kampanjer/valportalen/stortingsval/kvar-kan-du-royste.html_id=541963'"/>
...
<xsl:variable name="para_eng" select="'where-can-you-cast-your-vote.html_id=541963'"/>
