...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/om-departementet/organisasjon/Avdelingar.html_id=366'"/>
...
<xsl:variable name="para_eng" select="'departments.html_id=366'"/>
