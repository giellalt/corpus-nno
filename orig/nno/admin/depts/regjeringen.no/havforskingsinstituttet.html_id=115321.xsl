...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/Underliggjande-etatat/Havforskingsinstituttet.html_id=115321'"/>
...
<xsl:variable name="para_eng" select="'the-institute-of-marine-research.html_id=115321'"/>
