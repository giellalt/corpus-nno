...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/dokument/rapportar-og-planar/rapportar.html_id=1874'"/>
...
<xsl:variable name="para_eng" select="'reports.html_id=1874'"/>
