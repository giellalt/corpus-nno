...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/om-departementet/organisasjon/Avdelingar/kommunikasjonseining.html_id=521818'"/>
...
<xsl:variable name="para_eng" select="'the-ministry-of-defence-communication-un.html_id=521818'"/>
