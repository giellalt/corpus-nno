...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/dokument/Rettleiingar-og-brosjyrar.html_id=2134'"/>
...
<xsl:variable name="para_eng" select="'guidelines-and-brochures.html_id=2134'"/>
