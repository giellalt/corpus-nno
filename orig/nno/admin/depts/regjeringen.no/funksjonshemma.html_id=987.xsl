...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Tema/Funksjonshemma.html_id=987'"/>
...
<xsl:variable name="para_eng" select="'disabled-people.html_id=987'"/>
