...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/oed/Om-departementet/Organisasjon.html_id=774'"/>
...
<xsl:variable name="para_eng" select="'organisation.html_id=774'"/>
