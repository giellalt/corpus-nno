...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/proposisjonar-og-meldingar/meldst.html_id=1754'"/>
...
<xsl:variable name="para_nob" select="'meldst.html_id=1754'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stuorradiggedieahusat.html_id=1754'"/>
