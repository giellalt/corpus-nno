...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Utdanning-og-forsking.html_id=930'"/>
...
<xsl:variable name="para_eng" select="'education-and-research.html_id=930'"/>
