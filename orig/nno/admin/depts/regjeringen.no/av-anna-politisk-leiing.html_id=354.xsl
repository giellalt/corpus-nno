...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/aktuelt/taler-og-artiklar/av-anna-politisk-leiing.html_id=354'"/>
...
<xsl:variable name="para_nob" select="'av_ovrig_politisk_ledelse.html_id=354'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'av_ovrig_politisk_ledelse.html_id=354'"/>
