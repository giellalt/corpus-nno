...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/dokument/proposisjonar-og-meldingar.html_id=905'"/>
...
<xsl:variable name="para_eng" select="'propositions-and-reports.html_id=905'"/>
