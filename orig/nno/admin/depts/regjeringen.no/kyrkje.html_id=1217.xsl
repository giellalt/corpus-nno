...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/Tema/kyrkje.html_id=1217'"/>
...
<xsl:variable name="para_nob" select="'kirke.html_id=1217'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'girku.html_id=1217'"/>
