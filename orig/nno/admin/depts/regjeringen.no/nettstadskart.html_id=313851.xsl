...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Nettstadskart.html_id=313851'"/>
...
<xsl:variable name="para_eng" select="'site-map.html_id=313851'"/>
