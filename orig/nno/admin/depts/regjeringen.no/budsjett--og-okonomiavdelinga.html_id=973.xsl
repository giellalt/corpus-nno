...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn/organisasjon/avdelingar/Budsjett--og-okonomiavdelinga.html_id=973'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-finance.html_id=973'"/>
