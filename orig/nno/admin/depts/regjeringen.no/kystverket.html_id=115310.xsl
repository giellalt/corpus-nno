...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/Underliggjande-etatat/kystverket.html_id=115310'"/>
...
<xsl:variable name="para_eng" select="'the-norwegian-national-coastal-administr.html_id=115310'"/>
