...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fkd/dep/politisk_ledelse/vidar_ulriksen__statssekretar_ap/kalender/Besoker-Lyngen.html_id=615445'"/>
...
<xsl:variable name="para_nob" select="'besoker-lyngen.html_id=615445'"/>
