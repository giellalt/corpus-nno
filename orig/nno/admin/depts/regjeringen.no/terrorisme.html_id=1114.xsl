...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/samfunntryggleik-og-forsvar/Terrorisme.html_id=1114'"/>
...
<xsl:variable name="para_eng" select="'terrorism.html_id=1114'"/>
