...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/Underliggjande-etatar.html_id=115202'"/>
...
<xsl:variable name="para_nob" select="'underliggende-etater.html_id=115202'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'underliggende-etater.html_id=115202'"/>
