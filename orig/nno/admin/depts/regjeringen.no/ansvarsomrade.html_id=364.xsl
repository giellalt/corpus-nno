...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/om-departementet/ansvarsomrade.html_id=364'"/>
...
<xsl:variable name="para_nob" select="'ansvarsomraader.html_id=364'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ovdasiidu.html_id=364'"/>
