...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/Organisasjon/Avdelingar/Skattelovavdelinga.html_id=1549'"/>
...
<xsl:variable name="para_eng" select="'the-tax-law-department.html_id=1549'"/>
