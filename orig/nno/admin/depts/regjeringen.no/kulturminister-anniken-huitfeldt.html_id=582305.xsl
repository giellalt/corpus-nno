...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/kulturminister-anniken-huitfeldt.html_id=582305'"/>
...
<xsl:variable name="para_eng" select="'minister-of-culture-anniken-huitfeldt.html_id=582305'"/>
