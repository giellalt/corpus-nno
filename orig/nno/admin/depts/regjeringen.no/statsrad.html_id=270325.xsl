...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/Om-regjeringa/Slik-arbeider-regjeringa/statsrad.html_id=270325'"/>
...
<xsl:variable name="para_eng" select="'the-council-of-state.html_id=270325'"/>
