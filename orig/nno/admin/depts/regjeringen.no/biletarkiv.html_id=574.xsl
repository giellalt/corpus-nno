...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/pressesenter/Biletarkiv.html_id=574'"/>
...
<xsl:variable name="para_nob" select="'bildearkiv.html_id=574'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'govvaarkiiva.html_id=574'"/>
