...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/om-departementet/organisasjon/Avdelingar.html_id=654'"/>
...
<xsl:variable name="para_nob" select="'avdelinger.html_id=654'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ossodagat.html_id=654'"/>
