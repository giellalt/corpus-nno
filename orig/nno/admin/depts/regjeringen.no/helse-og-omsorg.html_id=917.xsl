...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Helse-og-omsorg.html_id=917'"/>
...
<xsl:variable name="para_eng" select="'health-and-care.html_id=917'"/>
