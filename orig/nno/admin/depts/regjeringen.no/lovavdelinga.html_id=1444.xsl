...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/Organisasjon/Avdelingar/Lovavdelinga.html_id=1444'"/>
...
<xsl:variable name="para_eng" select="'the-legislation-department.html_id=1444'"/>
