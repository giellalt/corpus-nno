...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/kampanjer/valportalen.html_id=456491'"/>
...
<xsl:variable name="para_eng" select="'election_portal.html_id=456491'"/>
