...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/Om-regjeringa/Slik-arbeider-regjeringa/Kva-skjer-ved-regjeringsskifte.html_id=270340'"/>
...
<xsl:variable name="para_eng" select="'change-of-government.html_id=270340'"/>
