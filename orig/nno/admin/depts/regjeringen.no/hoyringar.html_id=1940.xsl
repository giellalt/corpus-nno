...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/Hoyringar.html_id=1940'"/>
...
<xsl:variable name="para_nob" select="'hoeringer.html_id=1940'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gulaskuddamat.html_id=1940'"/>
