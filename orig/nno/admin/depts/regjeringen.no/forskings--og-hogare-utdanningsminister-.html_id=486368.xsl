...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kd/Om-departementet/forskings--og-hogare-utdanningsminister-.html_id=486368'"/>
...
<xsl:variable name="para_eng" select="'minister-of-research-and-higher-educatio.html_id=486368'"/>
