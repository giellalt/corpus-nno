...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/kultur-fritid-og-livssyn.html_id=920'"/>
...
<xsl:variable name="para_eng" select="'culture-leisure-and-belief-systems.html_id=920'"/>
