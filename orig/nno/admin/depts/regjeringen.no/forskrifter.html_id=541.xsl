...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/Lover-og-reglar/Forskrifter.html_id=541'"/>
...
<xsl:variable name="para_nob" select="'forskrifter.html_id=541'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lahkaasahusat.html_id=541'"/>
