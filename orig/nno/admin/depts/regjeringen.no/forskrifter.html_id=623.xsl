...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kd/Dokument/Lover-og-reglar/Forskrifter.html_id=623'"/>
...
<xsl:variable name="para_nob" select="'forskrifter.html_id=623'"/>
