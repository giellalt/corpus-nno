...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/Tilknytta-verksemder/Forskingsfondet-til-fiskeri--og-havbruksnaringa-.html_id=168263'"/>
...
<xsl:variable name="para_eng" select="'the-fishery-and-aquaculture-industry-res.html_id=168263'"/>
