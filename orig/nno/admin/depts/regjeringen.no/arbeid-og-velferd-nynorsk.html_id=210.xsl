...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/arbeid-og-velferd-nynorsk.html_id=210'"/>
...
<xsl:variable name="para_eng" select="'engelsk-tema.html_id=210'"/>
