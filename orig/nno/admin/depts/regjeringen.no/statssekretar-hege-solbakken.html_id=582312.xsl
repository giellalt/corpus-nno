...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Om-departementet/anna-politisk-leiing/statssekretar-hege-solbakken.html_id=582312'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-hege-solbakken.html_id=582312'"/>
