...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/Idrettsavdelinga/fungerande-ekspedisjonssjef-per-kristian.html_id=551554'"/>
...
<xsl:variable name="para_eng" select="'sadjasa-ekspediuvdnahoavda-per-kristian-.html_id=551554'"/>
