...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/md/Om-departementet/Underliggjande-etatar.html_id=115212'"/>
...
<xsl:variable name="para_eng" select="'subordinate-agencies.html_id=115212'"/>
