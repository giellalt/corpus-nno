...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Lov-og-rett/Kriminalitet-og-overgrep/Okonomisk-kriminalitet.html_id=1263'"/>
...
<xsl:variable name="para_nob" select="'okonomisk_kriminalitet.html_id=1263'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekonomala-rihkolavuohta.html_id=1263'"/>
