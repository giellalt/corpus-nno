...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/om-departementet/Tilknytta-verksemder.html_id=115197'"/>
...
<xsl:variable name="para_nob" select="'tilknyttede-virksomheter.html_id=115197'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'daidda-gulleva-doaimmat.html_id=115197'"/>
