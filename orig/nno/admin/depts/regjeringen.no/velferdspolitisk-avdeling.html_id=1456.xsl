...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn/organisasjon/avdelingar/Velferdspolitisk-avdeling.html_id=1456'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-welfare-policy.html_id=1456'"/>
