...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Internasjonalt.html_id=919'"/>
...
<xsl:variable name="para_eng" select="'international-relations.html_id=919'"/>
