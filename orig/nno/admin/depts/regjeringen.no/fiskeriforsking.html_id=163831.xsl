...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/Tilknytta-verksemder/fiskeriforsking.html_id=163831'"/>
...
<xsl:variable name="para_eng" select="'the-norwegian-institute-of-fisheries-and.html_id=163831'"/>
