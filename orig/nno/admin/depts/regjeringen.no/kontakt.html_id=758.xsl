...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/oed/Om-departementet/kontakt.html_id=758'"/>
...
<xsl:variable name="para_eng" select="'contact.html_id=758'"/>
