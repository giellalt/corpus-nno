...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/Organisasjon/Avdelingar/Polaravdelinga.html_id=1447'"/>
...
<xsl:variable name="para_eng" select="'the-polar-affairs-department.html_id=1447'"/>
