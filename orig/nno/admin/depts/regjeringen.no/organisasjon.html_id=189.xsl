...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn/organisasjon.html_id=189'"/>
...
<xsl:variable name="para_eng" select="'organization.html_id=189'"/>
