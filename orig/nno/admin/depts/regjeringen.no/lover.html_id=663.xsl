...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/dokument/Lover-og-reglar/Lover.html_id=663'"/>
...
<xsl:variable name="para_eng" select="'acts.html_id=663'"/>
