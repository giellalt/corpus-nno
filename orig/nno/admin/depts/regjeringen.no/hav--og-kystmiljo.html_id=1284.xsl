...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Tema/hav--og-kystmiljo.html_id=1284'"/>
...
<xsl:variable name="para_nob" select="'hav-_og_kystmiljo.html_id=1284'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ahpe--ja-riddobiras.html_id=1284'"/>
