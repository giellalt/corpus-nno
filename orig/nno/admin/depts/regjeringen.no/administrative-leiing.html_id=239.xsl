...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/Administrative-leiing.html_id=239'"/>
...
<xsl:variable name="para_eng" select="'senior-administrative-staff.html_id=239'"/>
