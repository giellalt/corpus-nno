...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/Nettstadskart.html_id=313854'"/>
...
<xsl:variable name="para_eng" select="'site-map.html_id=313854'"/>
