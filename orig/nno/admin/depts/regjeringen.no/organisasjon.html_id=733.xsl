...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/nhd/Om-departementet/Organisasjon.html_id=733'"/>
...
<xsl:variable name="para_eng" select="'organisation.html_id=733'"/>
