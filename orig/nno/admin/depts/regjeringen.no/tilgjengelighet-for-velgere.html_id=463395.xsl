...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/kampanjer/valg/for-valgmedarbeidere/tilgjengelighet-for-velgere.html_id=463395'"/>
...
<xsl:variable name="para_nob" select="'tilgjengelighet-for-velgere.html_id=463395'"/>
