...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/Medieavdelinga/Seksjon-M4.html_id=1483'"/>
...
<xsl:variable name="para_nob" select="'juridisk_seksjon.html_id=1483'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'juridihkala-sekuvdna.html_id=1483'"/>
