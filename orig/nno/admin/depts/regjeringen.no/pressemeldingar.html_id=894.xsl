...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/pressesenter/Pressemeldingar.html_id=894'"/>
...
<xsl:variable name="para_eng" select="'press-releases.html_id=894'"/>
