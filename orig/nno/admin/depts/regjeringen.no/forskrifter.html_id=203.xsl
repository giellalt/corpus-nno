...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/dokument/lover-og-reglar/forskrifter.html_id=203'"/>
...
<xsl:variable name="para_eng" select="'forskrifter.html_id=203'"/>
