...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/Idrettsavdelinga.html_id=1484'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-sport.html_id=1484'"/>
