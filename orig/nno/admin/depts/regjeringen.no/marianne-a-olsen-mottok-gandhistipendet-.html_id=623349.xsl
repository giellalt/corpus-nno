...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/pressesenter/pressemeldingar/Omorganisering-av-ABM/marianne-a-olsen-mottok-gandhistipendet-.html_id=623349'"/>
