...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/statsminister/Politiske-medarbeidarar.html_id=897'"/>
...
<xsl:variable name="para_eng" select="'political-staff.html_id=897'"/>
