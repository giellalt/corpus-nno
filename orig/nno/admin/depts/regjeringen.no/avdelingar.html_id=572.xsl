...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar.html_id=572'"/>
...
<xsl:variable name="para_eng" select="'departments.html_id=572'"/>
