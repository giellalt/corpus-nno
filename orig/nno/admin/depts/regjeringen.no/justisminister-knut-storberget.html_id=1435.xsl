...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/justisminister-knut-storberget.html_id=1435'"/>
...
<xsl:variable name="para_eng" select="'minister-of-justice-and-the-police.html_id=1435'"/>
