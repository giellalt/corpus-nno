...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/Organisasjon/Avdelingar/Kriminalomsorgsavdelinga.html_id=1446'"/>
...
<xsl:variable name="para_eng" select="'correctional-services-department.html_id=1446'"/>
