...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Underliggjande-etatar/norsk-filminstitutt.html_id=382400'"/>
...
<xsl:variable name="para_nob" select="'norsk-filminstitutt.html_id=382400'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'norgga-filbmainstituhtta-.html_id=382400'"/>
