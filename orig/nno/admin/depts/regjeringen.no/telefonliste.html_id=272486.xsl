...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/om-departementet/kontakt/Telefonliste.html_id=272486'"/>
...
<xsl:variable name="para_nob" select="'telefonliste.html_id=272486'"/>
