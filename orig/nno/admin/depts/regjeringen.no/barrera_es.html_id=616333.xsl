...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/ud/Om-departementet/utviklingsminister-erik-solheim-sv/Kalenderen-til-Utviklingsministeren/barrera_es.html_id=616333'"/>
...
<xsl:variable name="para_sme" select="'barrera_es.html_id=616333'"/>
