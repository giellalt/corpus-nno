...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/statsministerens-kontor-2/Organisasjon/Avdelingar.html_id=902'"/>
...
<xsl:variable name="para_eng" select="'departments.html_id=902'"/>
