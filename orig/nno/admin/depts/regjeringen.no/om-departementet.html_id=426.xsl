...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/hod/Om-departementet.html_id=426'"/>
...
<xsl:variable name="para_eng" select="'about-the-ministry.html_id=426'"/>
