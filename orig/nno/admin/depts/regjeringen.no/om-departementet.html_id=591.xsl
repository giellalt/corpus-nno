...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kd/Om-departementet.html_id=591'"/>
...
<xsl:variable name="para_eng" select="'about-the-ministry.html_id=591'"/>
