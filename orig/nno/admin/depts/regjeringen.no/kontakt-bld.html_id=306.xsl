...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/-Om-departementet/kontakt-bld.html_id=306'"/>
...
<xsl:variable name="para_eng" select="'contact.html_id=306'"/>
