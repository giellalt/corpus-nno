...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/samfunnssikkerheit.html_id=1120'"/>
...
<xsl:variable name="para_nob" select="'samfunnssikkerhet.html_id=1120'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'siviila-gearggusvuohta.html_id=1120'"/>
