...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Tema/Trygg-sjomat.html_id=1273'"/>
...
<xsl:variable name="para_nob" select="'trygg_og_sunn_sjomat.html_id=1273'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sihkkaris-ja-dearvvasla-mearrabiepmu.html_id=1273'"/>
