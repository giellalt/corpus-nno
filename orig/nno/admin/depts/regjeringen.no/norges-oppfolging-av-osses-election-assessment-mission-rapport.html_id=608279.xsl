...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/kampanjer/valg/valgobservasjon/Norges-oppfolging-av-OSSEs-Election-Assessment-Mission-rapport.html_id=608279'"/>
...
<xsl:variable name="para_eng" select="'the-norwegian-follow-up-of-osces-election-assessment-mission-report.html_id=608279'"/>
