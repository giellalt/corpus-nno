...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn.html_id=170'"/>
...
<xsl:variable name="para_eng" select="'about-the-ministry.html_id=170'"/>
