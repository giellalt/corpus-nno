...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/ud/Om-departementet/kontakt.html_id=841'"/>
...
<xsl:variable name="para_eng" select="'contact.html_id=841'"/>
