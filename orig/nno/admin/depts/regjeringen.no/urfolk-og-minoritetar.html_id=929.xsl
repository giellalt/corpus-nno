...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Urfolk-og-minoritetar.html_id=929'"/>
...
<xsl:variable name="para_eng" select="'indigenous-peoples-and-minorities.html_id=929'"/>
