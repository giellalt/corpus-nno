...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Pressesenter/Pressemeldingar.html_id=317'"/>
...
<xsl:variable name="para_eng" select="'press-releases.html_id=317'"/>
