...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/Veg--og-baneavdelinga-VB/Banseseksjonen-BS.html_id=332360'"/>
...
<xsl:variable name="para_nob" select="'banseseksjonen-bs.html_id=332360'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'banasekuvdna.html_id=332360'"/>
