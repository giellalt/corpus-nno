...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/oed/Nettstadskart.html_id=313868'"/>
...
<xsl:variable name="para_eng" select="'site-map.html_id=313868'"/>
