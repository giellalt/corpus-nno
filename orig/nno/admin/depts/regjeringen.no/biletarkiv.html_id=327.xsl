...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Pressesenter/Biletarkiv.html_id=327'"/>
...
<xsl:variable name="para_eng" select="'picture-archive.html_id=327'"/>
