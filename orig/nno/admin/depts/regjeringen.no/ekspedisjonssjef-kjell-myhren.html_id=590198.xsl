...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/kunstavdelinga/ekspedisjonssjef-kjell-myhren.html_id=590198'"/>
...
<xsl:variable name="para_eng" select="'director-general-kjell-myhren.html_id=590198'"/>
