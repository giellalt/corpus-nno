...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Underliggjande-etatar/medietilsynet.html_id=279656'"/>
...
<xsl:variable name="para_nob" select="'medietilsynet.html_id=279656'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'mediabearraigeahu.html_id=279656'"/>
