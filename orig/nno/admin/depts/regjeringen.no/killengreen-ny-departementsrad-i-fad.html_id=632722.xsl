...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/pressesenter/Pressemeldingar/2011/killengreen-ny-departementsrad-i-fad.html_id=632722'"/>
...
<xsl:variable name="para_nob" select="'killengreen-ny-departementsrad-i-fad.html_id=632722'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'killengreen-fad-oa-departemeantarai.html_id=632722'"/>
