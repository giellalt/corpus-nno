...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/Kontakt.html_id=265'"/>
...
<xsl:variable name="para_eng" select="'contact-the-norwegian-ministry-of-fisheries-and-coastal-affairs.html_id=265'"/>
