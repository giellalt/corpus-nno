...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/Nettstadskart.html_id=313857'"/>
...
<xsl:variable name="para_eng" select="'site-map.html_id=313857'"/>
