...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/pressesenter/pressemeldingar/Omorganisering-av-ABM/12-millionar-kroner-til-tiltak-mot-speleproblem.html_id=625285'"/>
...
<xsl:variable name="para_sme" select="'12-miljovnna-ruvnno-speallansorjavavuoa-.html_id=625285'"/>
