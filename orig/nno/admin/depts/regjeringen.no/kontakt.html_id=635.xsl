...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/om-departementet/kontakt.html_id=635'"/>
...
<xsl:variable name="para_eng" select="'contact-information.html_id=635'"/>
