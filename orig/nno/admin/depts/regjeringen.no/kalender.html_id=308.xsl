...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Aktuelt/kalender.html_id=308'"/>
...
<xsl:variable name="para_eng" select="'calendar-for-the-ministry-of-children-an.html_id=308'"/>
