...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/Anna-politisk-leiing-/roger-schjerva.html_id=272481'"/>
...
<xsl:variable name="para_eng" select="'roger-schjerva.html_id=272481'"/>
