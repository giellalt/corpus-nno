...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/om-departementet/organisasjon.html_id=651'"/>
...
<xsl:variable name="para_eng" select="'the-ministrys-departments.html_id=651'"/>
