...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/Pressemeldingar/Mange-kommunar-med-auka-folketal-fyrste-kvartal-2010/1378-millionar-kroner-til-regional-utvik.html_id=619654'"/>
...
<xsl:variable name="para_sme" select="'1378-miljovnna-ruvdno-guovlula-ovdaneapm.html_id=619654'"/>
