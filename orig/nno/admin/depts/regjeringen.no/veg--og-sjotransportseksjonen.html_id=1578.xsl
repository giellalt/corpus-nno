...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/transportavdelinga-ta/Veg--og-sjotransportseksjonen.html_id=1578'"/>
...
<xsl:variable name="para_nob" select="'veg-_og_sjotransportseksjonen.html_id=1578'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'biras--ja-farrolasjohtolatsekuvdna.html_id=1578'"/>
