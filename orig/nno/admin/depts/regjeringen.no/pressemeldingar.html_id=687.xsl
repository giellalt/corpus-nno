...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/md/pressesenter/Pressemeldingar.html_id=687'"/>
...
<xsl:variable name="para_eng" select="'press-releases.html_id=687'"/>
