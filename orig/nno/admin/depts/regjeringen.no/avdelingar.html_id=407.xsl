...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fd/om-departementet/organisasjon/Avdelingar.html_id=407'"/>
...
<xsl:variable name="para_eng" select="'departments.html_id=407'"/>
