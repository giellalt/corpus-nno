...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/Organisasjon/Avdelingar/Finansmarknadsavdelinga.html_id=1551'"/>
...
<xsl:variable name="para_eng" select="'financial_markets_department.html_id=1551'"/>
