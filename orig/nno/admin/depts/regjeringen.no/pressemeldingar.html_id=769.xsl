...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/oed/pressesenter/Pressemeldingar.html_id=769'"/>
...
<xsl:variable name="para_eng" select="'press-releases.html_id=769'"/>
