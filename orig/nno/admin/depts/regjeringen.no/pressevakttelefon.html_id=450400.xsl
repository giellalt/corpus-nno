...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Pressesenter/Pressemeldingar/2007/Pressevakttelefon.html_id=450400'"/>
...
<xsl:variable name="para_eng" select="'media-contact-line.html_id=450400'"/>
