...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/-Om-departementet/organisasjon/Avdelingar/Forbrukaravdelinga.html_id=83'"/>
...
<xsl:variable name="para_eng" select="'department-of-consumer-affairs.html_id=83'"/>
