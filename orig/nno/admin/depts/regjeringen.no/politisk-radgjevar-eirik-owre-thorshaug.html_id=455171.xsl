...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/Anna-politisk-leiing/Politisk-radgjevar-Eirik-Owre-Thorshaug.html_id=455171'"/>
...
<xsl:variable name="para_eng" select="'political-advisor-eirik-owre-thorshaug.html_id=455171'"/>
