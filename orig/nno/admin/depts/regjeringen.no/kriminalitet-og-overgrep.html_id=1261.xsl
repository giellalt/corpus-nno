...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Lov-og-rett/Kriminalitet-og-overgrep.html_id=1261'"/>
...
<xsl:variable name="para_eng" select="'crime-and-abuse.html_id=1261'"/>
