...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/familie-og-oppvekst.html_id=213'"/>
...
<xsl:variable name="para_eng" select="'families-and-upbringing.html_id=213'"/>
