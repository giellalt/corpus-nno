...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/statsministerens-kontor-2/Organisasjon/Avdelingar/presse--og-informasjonsseksjonen/Kommunikasjonsradgjevar-Arvid-Samland.html_id=503357'"/>
...
<xsl:variable name="para_eng" select="'communication-officer-arvid-samland.html_id=503357'"/>
