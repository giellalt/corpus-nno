...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Tema/havbruksnaringa.html_id=1282'"/>
...
<xsl:variable name="para_nob" select="'akvakultur.html_id=1282'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'akvakultuvra.html_id=1282'"/>
