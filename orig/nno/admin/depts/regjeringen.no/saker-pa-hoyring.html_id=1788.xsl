...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/dokument/Hoyringar/Saker-pa-hoyring.html_id=1788'"/>
...
<xsl:variable name="para_nob" select="'paa_hoering.html_id=1788'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ait-gulaskuddamis.html_id=1788'"/>
