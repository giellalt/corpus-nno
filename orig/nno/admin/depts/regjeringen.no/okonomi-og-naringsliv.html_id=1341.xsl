...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Naringsliv/Okonomi-og-naringsliv.html_id=1341'"/>
...
<xsl:variable name="para_nob" select="'okonomi.html_id=1341'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekonomiija-ja-ealahuseallin.html_id=1341'"/>
