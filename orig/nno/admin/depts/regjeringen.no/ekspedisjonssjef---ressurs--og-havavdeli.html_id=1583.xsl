...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/organisasjon/Avdelingar/ressurs--og-havavdelinga/ekspedisjonssjef---ressurs--og-havavdeli.html_id=1583'"/>
...
<xsl:variable name="para_eng" select="'director-general---department-of-marine-.html_id=1583'"/>
