...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/om-departementet/Anna-politisk-leiing.html_id=649'"/>
...
<xsl:variable name="para_eng" select="'other-political-staff.html_id=649'"/>
