...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/md/dokument/lover-og-reglar.html_id=271041'"/>
...
<xsl:variable name="para_eng" select="'acts-and-regulations.html_id=271041'"/>
