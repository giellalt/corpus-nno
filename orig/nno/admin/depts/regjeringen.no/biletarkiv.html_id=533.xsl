...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/biletarkiv.html_id=533'"/>
...
<xsl:variable name="para_eng" select="'picture-archive.html_id=533'"/>
