...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/Organisasjon/Avdelingar.html_id=243'"/>
...
<xsl:variable name="para_eng" select="'departments.html_id=243'"/>
