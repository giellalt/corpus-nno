...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon.html_id=569'"/>
...
<xsl:variable name="para_eng" select="'organisation.html_id=569'"/>
