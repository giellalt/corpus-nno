...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/Anna-politisk-leiing.html_id=279'"/>
...
<xsl:variable name="para_eng" select="'other-political-staff.html_id=279'"/>
