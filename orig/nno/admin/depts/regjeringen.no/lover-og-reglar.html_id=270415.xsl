...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/dokument/lover-og-reglar.html_id=270415'"/>
...
<xsl:variable name="para_sme" select="'lover_regler.html_id=270415'"/>
