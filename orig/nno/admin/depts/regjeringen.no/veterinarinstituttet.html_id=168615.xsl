...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/Tilknytta-verksemder/Veterinarinstituttet.html_id=168615'"/>
...
<xsl:variable name="para_eng" select="'the-national-veterinary-institute.html_id=168615'"/>
