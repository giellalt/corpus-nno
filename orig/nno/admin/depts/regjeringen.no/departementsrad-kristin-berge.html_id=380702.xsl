...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Administrativ-leiing/departementsrad-kristin-berge.html_id=380702'"/>
...
<xsl:variable name="para_eng" select="'secretary-general-kristin-berge.html_id=380702'"/>
