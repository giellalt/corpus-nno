...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Tema/regional-_og_distriktspolitikk/utvikling-av-bedrifter-og-naringsmiljo/etablerte-bedrifter.html_id=530953'"/>
...
<xsl:variable name="para_eng" select="'established-companies.html_id=530953'"/>
