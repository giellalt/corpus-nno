...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/pressesenter/pressemeldingar/2008/stort-musikkloft-for-troms.html_id=528952'"/>
...
<xsl:variable name="para_sme" select="'stuorra-musihkkaagiruan-romssa-fylkii.html_id=528952'"/>
