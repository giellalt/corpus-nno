...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/-Om-departementet/organisasjon/Avdelingar.html_id=325'"/>
...
<xsl:variable name="para_eng" select="'departments.html_id=325'"/>
