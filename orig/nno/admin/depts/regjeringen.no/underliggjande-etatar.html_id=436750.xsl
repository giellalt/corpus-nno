...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/om-departementet/Underliggjande-etatar.html_id=436750'"/>
...
<xsl:variable name="para_nob" select="'underliggende-etater.html_id=436750'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'underliggende-etater.html_id=436750'"/>
