...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/dokument/Tidsskrift-og-nyheitsbrev.html_id=1797'"/>
...
<xsl:variable name="para_nob" select="'tidsskrift_nyhetsbrev.html_id=1797'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'aigecallagat-ja-odasreivvet.html_id=1797'"/>
