...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/Tilknytta-verksemder/Forskingsradet.html_id=164556'"/>
...
<xsl:variable name="para_eng" select="'the-research-council-of-norway-.html_id=164556'"/>
