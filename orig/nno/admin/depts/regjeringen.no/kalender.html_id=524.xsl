...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/kalender.html_id=524'"/>
...
<xsl:variable name="para_nob" select="'kalender.html_id=524'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kaleanddar.html_id=524'"/>
