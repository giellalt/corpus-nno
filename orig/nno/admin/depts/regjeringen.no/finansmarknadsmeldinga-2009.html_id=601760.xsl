...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/pressesenter/Pressemeldingar/2010/Finansmarknadsmeldinga-2009.html_id=601760'"/>
...
<xsl:variable name="para_sme" select="'finansamarkandieahus-2009.html_id=601760'"/>
