...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Departemeanta-birra/Organisasvdna/Ossodagat-/Organisauvnnaid-ja-ekonomiija-ossodat-/Ekspediuvdnahoavda-Jon-Rorvik.html_id=85634'"/>
...
<xsl:variable name="para_eng" select="'director-general-jon-rorvik.html_id=85634'"/>
