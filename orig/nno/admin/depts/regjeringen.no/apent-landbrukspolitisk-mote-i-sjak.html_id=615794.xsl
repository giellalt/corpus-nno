...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/lmd/dep/politisk_ledelse/statssekretar_ola_t_heggem_/kalender/2010/Apent-landbrukspolitisk-mote-i-Sjak.html_id=615794'"/>
...
<xsl:variable name="para_nob" select="'apent-landbrukspolitisk-mote-i-sjak.html_id=615794'"/>
