...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/dok/horinger/horingsdokumenter/2010/horing---endringer-i-forskrift-om-lonns-.html_id=610806'"/>
...
<xsl:variable name="para_nob" select="'horing---endringer-i-forskrift-om-lonns-.html_id=610806'"/>
