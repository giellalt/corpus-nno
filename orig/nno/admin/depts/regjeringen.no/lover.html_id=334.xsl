...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/Dokument/Lover-og-reglar/Lover.html_id=334'"/>
...
<xsl:variable name="para_eng" select="'laws.html_id=334'"/>
