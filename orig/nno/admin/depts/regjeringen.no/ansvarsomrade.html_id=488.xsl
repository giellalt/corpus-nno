...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/Ansvarsomrade.html_id=488'"/>
...
<xsl:variable name="para_nob" select="'ansvarsomraader.html_id=488'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'roahpisteapmi.html_id=488'"/>
