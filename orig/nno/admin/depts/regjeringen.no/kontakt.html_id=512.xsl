...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Om-departementet/Kontakt.html_id=512'"/>
...
<xsl:variable name="para_eng" select="'contact.html_id=512'"/>
