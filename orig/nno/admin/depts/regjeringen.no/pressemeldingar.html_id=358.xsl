...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/pressesenter/Pressemeldingar.html_id=358'"/>
...
<xsl:variable name="para_eng" select="'press-releases.html_id=358'"/>
