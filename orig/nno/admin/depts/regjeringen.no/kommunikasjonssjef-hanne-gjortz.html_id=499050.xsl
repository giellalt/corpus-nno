...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/informasjonseininga/kommunikasjonssjef-hanne-gjortz.html_id=499050'"/>
...
<xsl:variable name="para_eng" select="'head-of-communication-hanne-gjortz.html_id=499050'"/>
