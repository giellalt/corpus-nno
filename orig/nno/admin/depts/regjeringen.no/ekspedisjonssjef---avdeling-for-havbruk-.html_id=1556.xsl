...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/organisasjon/Avdelingar/avdeling-for-havbruk-sjomat-og-marknad/ekspedisjonssjef---avdeling-for-havbruk-.html_id=1556'"/>
...
<xsl:variable name="para_eng" select="'director-general--department-of-aquaculture-seafood-and-markets.html_id=1556'"/>
