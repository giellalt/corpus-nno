...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/kampanjer/valg/for-valgmedarbeidere/rapporter.html_id=458184'"/>
...
<xsl:variable name="para_nob" select="'rapporter.html_id=458184'"/>
