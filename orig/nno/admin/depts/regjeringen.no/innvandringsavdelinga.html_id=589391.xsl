...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/Organisasjon/Avdelingar/innvandringsavdelinga.html_id=589391'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-migration.html_id=589391'"/>
