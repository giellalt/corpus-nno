...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/pressesenter/Bildearkiv.html_id=904'"/>
...
<xsl:variable name="para_eng" select="'photo-gallery.html_id=904'"/>
