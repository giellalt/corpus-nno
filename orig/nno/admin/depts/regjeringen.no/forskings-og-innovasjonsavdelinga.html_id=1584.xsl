...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/organisasjon/Avdelingar/forskings-og-innovasjonsavdelinga.html_id=1584'"/>
...
<xsl:variable name="para_eng" select="'department-of-research-and-innovation---.html_id=1584'"/>
