...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/oed/Om-departementet.html_id=755'"/>
...
<xsl:variable name="para_eng" select="'the-ministey.html_id=755'"/>
