...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/kontakt.html_id=799'"/>
...
<xsl:variable name="para_eng" select="'contact.html_id=799'"/>
