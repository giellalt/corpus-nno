...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/landbruket-sin-miljo--og-arealpolitikk.html_id=503484'"/>
...
<xsl:variable name="para_nob" select="'landbrukets-miljo--og-arealpolitikk.html_id=503484'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eanadoalu-biras--ja-eanapolitihkka.html_id=503484'"/>
