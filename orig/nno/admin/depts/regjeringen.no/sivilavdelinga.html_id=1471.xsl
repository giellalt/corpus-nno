...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/jd/Om-departementet/Organisasjon/Avdelingar/Sivilavdelinga.html_id=1471'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-civil-affairs.html_id=1471'"/>
