...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Mat-fiskeri-og-landbruk/Landbruk.html_id=85943'"/>
...
<xsl:variable name="para_eng" select="'agriculture.html_id=85943'"/>
