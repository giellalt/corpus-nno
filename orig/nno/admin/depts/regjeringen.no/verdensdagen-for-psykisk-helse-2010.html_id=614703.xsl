...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ad/dep/arbeidsminister-hanne-bjurstrom/kalender/Verdensdagen-for-psykisk-helse-2010.html_id=614703'"/>
...
<xsl:variable name="para_nob" select="'verdensdagen-for-psykisk-helse-2010.html_id=614703'"/>
