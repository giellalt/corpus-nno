...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/om-departementet.html_id=632'"/>
...
<xsl:variable name="para_eng" select="'the-ministry-of-agriculture-and-food.html_id=632'"/>
