...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/aktuelt/taler-og-artiklar/minister.html_id=574479'"/>
...
<xsl:variable name="para_nob" select="'minister.html_id=574479'"/>
