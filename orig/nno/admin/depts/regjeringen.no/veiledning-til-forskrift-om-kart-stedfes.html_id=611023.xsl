...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/dok/veiledninger/2010/veiledning-til-forskrift-om-kart-stedfes.html_id=611023'"/>
...
<xsl:variable name="para_nob" select="'veiledning-til-forskrift-om-kart-stedfes.html_id=611023'"/>
