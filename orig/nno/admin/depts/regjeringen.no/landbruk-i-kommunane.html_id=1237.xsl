...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/landbruk-i-kommunane.html_id=1237'"/>
...
<xsl:variable name="para_nob" select="'landbruk_i_kommunene.html_id=1237'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'suohkaniid-eanadoallu.html_id=1237'"/>
