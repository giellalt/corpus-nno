...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/jordbruksoppgjeret.html_id=1287'"/>
...
<xsl:variable name="para_nob" select="'jordbruksoppgjoret.html_id=1287'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eanadoallohadderaadallamat.html_id=1287'"/>
