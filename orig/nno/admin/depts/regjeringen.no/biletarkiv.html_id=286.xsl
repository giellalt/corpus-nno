...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Pressesenter/Biletarkiv.html_id=286'"/>
...
<xsl:variable name="para_eng" select="'picture-archive.html_id=286'"/>
