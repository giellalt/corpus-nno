...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/om-departementet/Underliggjande-etatar.html_id=115196'"/>
...
<xsl:variable name="para_nob" select="'underliggende-etater.html_id=115196'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'vuollasa-asahusat.html_id=115196'"/>
