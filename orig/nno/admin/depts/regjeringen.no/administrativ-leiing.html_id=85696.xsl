...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/md/Om-departementet/Administrativ-leiing.html_id=85696'"/>
...
<xsl:variable name="para_eng" select="'senior-administrative-staff.html_id=85696'"/>
