...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/pressesenter/pressemeldingar/2008/mange-kulturtiltak-i-finnmark-far-auka-s.html_id=528951'"/>
...
<xsl:variable name="para_sme" select="'ollu-kulturdoaibmabijuide-finnmarkkus-ju.html_id=528951'"/>
