...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/kunstavdelinga.html_id=590158'"/>
...
<xsl:variable name="para_eng" select="'department-for-the-arts.html_id=590158'"/>
