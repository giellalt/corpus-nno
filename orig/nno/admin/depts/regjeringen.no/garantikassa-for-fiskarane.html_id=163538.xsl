...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/Tilknytta-verksemder/Garantikassa-for-fiskarane.html_id=163538'"/>
...
<xsl:variable name="para_eng" select="'the-guarantee-fund-for-fishermen.html_id=163538'"/>
