...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/pressesenter/Pressemeldingar/Mange-kommunar-med-auka-folketal-fyrste-kvartal-2010/bulystmidlar-til-prosjektet-samdrift--ei.html_id=610478'"/>
...
<xsl:variable name="para_sma" select="'arromelastoeviertieh-prosjektasse-laaven.html_id=610478'"/>
