...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/sd/om-departementet/organisasjon/avdelingar/Luft--post--og-teleavdelinga/Luftfartsseksjonen.html_id=332354'"/>
...
<xsl:variable name="para_nob" select="'luftfartsseksjonen-ls.html_id=332354'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'luodda--ja-mearrajohtolatsekuvdna.html_id=332354'"/>
