...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/hod/Om-departementet/Kontakt.html_id=429'"/>
...
<xsl:variable name="para_eng" select="'contact-information.html_id=429'"/>
