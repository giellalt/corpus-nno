...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/reindrift.html_id=1296'"/>
...
<xsl:variable name="para_nob" select="'reindrift.html_id=1296'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'boazodoallu.html_id=1296'"/>
