...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/fiskeri--og-kystminister-lisbeth-berg-ha.html_id=582211'"/>
...
<xsl:variable name="para_eng" select="'minister-of-fisheries-and-coastal-affair.html_id=582211'"/>
