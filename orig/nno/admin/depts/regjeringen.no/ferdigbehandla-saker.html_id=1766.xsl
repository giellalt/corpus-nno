...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dok/Hoyringar/Ferdigbehandla-saker.html_id=1766'"/>
...
<xsl:variable name="para_nob" select="'ferdigbehandlet.html_id=1766'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'garvvisin-meannuduvvon-ait.html_id=1766'"/>
