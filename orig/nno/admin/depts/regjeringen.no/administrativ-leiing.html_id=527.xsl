...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Om-departementet/Administrativ-leiing.html_id=527'"/>
...
<xsl:variable name="para_eng" select="'administrative-staff.html_id=527'"/>
