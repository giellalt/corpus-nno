...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/krd/Dokument/Lover-og-reglar/Lover.html_id=540'"/>
...
<xsl:variable name="para_eng" select="'acts.html_id=540'"/>
