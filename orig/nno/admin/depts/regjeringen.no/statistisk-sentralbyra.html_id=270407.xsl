...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fin/Om-Departementet/etatar-og-verksemder/Statistisk-sentralbyra.html_id=270407'"/>
...
<xsl:variable name="para_eng" select="'statistics-norway.html_id=270407'"/>
