...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/oed/Om-departementet/anna-politisk-leiing.html_id=772'"/>
...
<xsl:variable name="para_eng" select="'other-political-staff.html_id=772'"/>
