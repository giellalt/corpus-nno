...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/dep/kommunal--og-regionalminister-liv-signe-/kalender/Moter-Nord-Trondelag-Energi-om-bredband.html_id=620373'"/>
...
<xsl:variable name="para_nob" select="'moter-nord-trondelag-energi-om-bredband.html_id=620373'"/>
