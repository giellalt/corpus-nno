...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kd/Om-departementet/kontakt.html_id=594'"/>
...
<xsl:variable name="para_eng" select="'contact.html_id=594'"/>
