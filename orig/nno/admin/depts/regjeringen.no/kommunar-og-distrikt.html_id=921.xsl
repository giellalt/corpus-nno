...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/tema/Kommunar-og-distrikt.html_id=921'"/>
...
<xsl:variable name="para_eng" select="'municipalities-and-regions.html_id=921'"/>
