...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Departemeanta-birra/Organisasvdna/Ossodagat-/Luondduhalddaanossodat/Ekspediuvdnahoavda-Torkel-Ramberg.html_id=1319'"/>
...
<xsl:variable name="para_eng" select="'director-general-torkel-ramberg.html_id=1319'"/>
