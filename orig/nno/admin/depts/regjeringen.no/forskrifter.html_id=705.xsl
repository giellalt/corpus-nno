...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/md/dokument/lover-og-reglar/forskrifter.html_id=705'"/>
...
<xsl:variable name="para_eng" select="'regulations.html_id=705'"/>
