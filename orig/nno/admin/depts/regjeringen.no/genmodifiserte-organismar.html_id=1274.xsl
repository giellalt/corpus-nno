...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/tema/genmodifiserte-organismar.html_id=1274'"/>
...
<xsl:variable name="para_nob" select="'genmodifiserte_organismer.html_id=1274'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'genalaat-heivehuvvon-organismmat.html_id=1274'"/>
