...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/om-departementet/fornyings--og-kyrkjeminister-rigmor-aasr.html_id=582206'"/>
...
<xsl:variable name="para_eng" select="'minister-of-reform-and-church-affairs-ri.html_id=582206'"/>
