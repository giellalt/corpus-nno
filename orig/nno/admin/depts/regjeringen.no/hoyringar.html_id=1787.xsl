...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/dokument/Hoyringar.html_id=1787'"/>
...
<xsl:variable name="para_nob" select="'hoeringer.html_id=1787'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'johtoallosat.html_id=1787'"/>
