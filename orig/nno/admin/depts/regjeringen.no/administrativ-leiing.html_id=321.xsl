...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/-Om-departementet/administrativ-leiing.html_id=321'"/>
...
<xsl:variable name="para_eng" select="'administrative-leadership.html_id=321'"/>
