...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fad/Tema/Nasjonale-minoritetar.html_id=1404'"/>
...
<xsl:variable name="para_eng" select="'national-minorities.html_id=1404'"/>
