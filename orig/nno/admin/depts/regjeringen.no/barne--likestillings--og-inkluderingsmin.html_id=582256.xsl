...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/bld/-Om-departementet/barne--likestillings--og-inkluderingsmin.html_id=582256'"/>
...
<xsl:variable name="para_eng" select="'audun-lysbakken.html_id=582256'"/>
