...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn/organisasjon/avdelingar/Arbeidsmiljo--og-sikkerheitsavdelinga.html_id=972'"/>
...
<xsl:variable name="para_eng" select="'the-working-environment-and-safety-depar.html_id=972'"/>
