...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/nhd/Om-departementet/Organisasjon/Avdelingar.html_id=736'"/>
...
<xsl:variable name="para_eng" select="'departments.html_id=736'"/>
