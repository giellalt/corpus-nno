...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/hod/Om-departementet/organisasjon.html_id=445'"/>
...
<xsl:variable name="para_nob" select="'org.html_id=445'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'organisauvdna-.html_id=445'"/>
