...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/Medieavdelinga/Seksjon-M1.html_id=551455'"/>
...
<xsl:variable name="para_nob" select="'forste-medieseksjon-m1.html_id=551455'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sekuvdna-m1.html_id=551455'"/>
