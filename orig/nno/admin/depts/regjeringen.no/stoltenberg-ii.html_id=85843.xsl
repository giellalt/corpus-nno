...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/Om-regjeringa/stoltenberg-ii.html_id=85843'"/>
...
<xsl:variable name="para_eng" select="'stoltenberg-ii.html_id=85843'"/>
