...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Om-departementet/Anna-politisk-leiing/vidar_ulriksen__statssekretar_ap/Biletarkiv.html_id=438704'"/>
...
<xsl:variable name="para_eng" select="'picture-archive.html_id=438704'"/>
