...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Anna-politisk-leiing/statssekretar-lubna-jaffery-fjell.html_id=582630'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-lubna-jaffery-fjell.html_id=582630'"/>
