...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/organisasjon/avdelingar/kulturvernavdelinga-/fungerande-ekspedisjonssjef-roy-kristian.html_id=590197'"/>
...
<xsl:variable name="para_eng" select="'acting-director-general-roy-kristiansen.html_id=590197'"/>
