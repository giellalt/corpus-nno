...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/Underliggjande-etatar/kunst-i-offentlege-rom-koro.html_id=408528'"/>
...
<xsl:variable name="para_nob" select="'utsmykkingsfondet-for-offentlige-bygg.html_id=408528'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'almmola-visttiid-iahanfoanda-.html_id=408528'"/>
