...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/pressesenter/pressemeldingar/kirsten-almas-utnemnd-til-prost-i-byasen/meir-til-samiske-kulturformal.html_id=581502'"/>
...
<xsl:variable name="para_sme" select="'eambbo-sami-kulturulbmiliidda.html_id=581502'"/>
