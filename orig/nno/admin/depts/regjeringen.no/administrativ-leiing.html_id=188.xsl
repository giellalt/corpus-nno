...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/om-departementetnn/Administrativ-leiing.html_id=188'"/>
...
<xsl:variable name="para_eng" select="'administrative-leadership.html_id=188'"/>
