...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/kud/om-departementet/kontakt.html_id=553'"/>
...
<xsl:variable name="para_eng" select="'contact-information.html_id=553'"/>
