...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/ud/Om-departementet/utviklingsminister-erik-solheim-sv.html_id=85897'"/>
...
<xsl:variable name="para_eng" select="'minister_development.html_id=85897'"/>
