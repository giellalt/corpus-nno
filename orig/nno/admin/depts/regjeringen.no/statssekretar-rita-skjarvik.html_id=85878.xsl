...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/smk/statsminister/Politiske-medarbeidarar/statssekretar-rita-skjarvik.html_id=85878'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-rita-skjarvik.html_id=85878'"/>
