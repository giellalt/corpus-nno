...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/aid/dokument/rapportar-og-planer/rapportar.html_id=1793'"/>
...
<xsl:variable name="para_nob" select="'rapporter.html_id=1793'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'raporttat-.html_id=1793'"/>
