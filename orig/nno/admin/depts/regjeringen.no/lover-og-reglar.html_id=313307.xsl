...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/lmd/dokument/Lover-og-reglar.html_id=313307'"/>
...
<xsl:variable name="para_eng" select="'acts-and-regulations.html_id=313307'"/>
