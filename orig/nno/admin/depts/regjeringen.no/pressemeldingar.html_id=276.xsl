...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/fkd/Pressesenter/Pressemeldingar.html_id=276'"/>
...
<xsl:variable name="para_eng" select="'press-releases.html_id=276'"/>
