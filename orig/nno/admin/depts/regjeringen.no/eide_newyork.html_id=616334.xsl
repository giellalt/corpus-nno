...
<xsl:variable name="filename" select="'http://regjeringen.no/nn/dep/ud/Om-departementet/Anna-politisk-leiing/cv_eide/ebei_kalender/eide_newyork.html_id=616334'"/>
